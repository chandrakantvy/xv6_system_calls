...
000001fa <main>:
{
 ...
 275:	68 90 09 00 00       	push   $0x990
 27a:	6a 02                	push   $0x2
 27c:	e8 4f 04 00 00       	call   6d0 <printf>
    exit();
 ...
 299:	ff 37                	pushl  (%edi)
 29b:	68 b0 09 00 00       	push   $0x9b0
 2a0:	6a 01                	push   $0x1
 2a2:	e8 29 04 00 00       	call   6d0 <printf>
      exit();
...
putc(int fd, char c)
{
 ...
 635:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
 638:	6a 01                	push   $0x1
 63a:	8d 55 f4             	lea    -0xc(%ebp),%edx
 63d:	52                   	push   %edx
 63e:	50                   	push   %eax
 63f:	e8 23 ff ff ff       	call   567 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 655:	89 d6                	mov    %edx,%esi
  ...
  neg = 0;
  if(sgn && xx < 0){
 657:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 65b:	0f 95 c2             	setne  %dl
 65e:	89 f0                	mov    %esi,%eax
 660:	c1 e8 1f             	shr    $0x1f,%eax
 663:	84 c2                	test   %al,%dl
 665:	74 42                	je     6a9 <printint+0x60>
    neg = 1;
    x = -xx;
 667:	f7 de                	neg    %esi
    neg = 1;
 669:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
 670:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
 675:	89 f0                	mov    %esi,%eax
 677:	ba 00 00 00 00       	mov    $0x0,%edx
 67c:	f7 f1                	div    %ecx
 67e:	89 df                	mov    %ebx,%edi
 680:	83 c3 01             	add    $0x1,%ebx
 683:	0f b6 92 d0 09 00 00 	movzbl 0x9d0(%edx),%edx
 68a:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
 68e:	89 f2                	mov    %esi,%edx
 690:	89 c6                	mov    %eax,%esi
 692:	39 d1                	cmp    %edx,%ecx
 694:	76 df                	jbe    675 <printint+0x2c>
  if(neg)
 696:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 69a:	74 2f                	je     6cb <printint+0x82>
    buf[i++] = '-';
 69c:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
 6a1:	8d 5f 02             	lea    0x2(%edi),%ebx
 6a4:	8b 75 d0             	mov    -0x30(%ebp),%esi
 6a7:	eb 15                	jmp    6be <printint+0x75>
  neg = 0;
 6a9:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 6b0:	eb be                	jmp    670 <printint+0x27>

  while(--i >= 0)
    putc(fd, buf[i]);
 6b2:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 6b7:	89 f0                	mov    %esi,%eax
 6b9:	e8 71 ff ff ff       	call   62f <putc>
  while(--i >= 0)
 6be:	83 eb 01             	sub    $0x1,%ebx
 6c1:	79 ef                	jns    6b2 <printint+0x69>
}
 ...
 6ce:	eb ee                	jmp    6be <printint+0x75>
...
printf(int fd, char *fmt, ...)
{
 ...
 6da:	83 ec 1c             	sub    $0x1c,%esp
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
 6dd:	8d 45 10             	lea    0x10(%ebp),%eax
 6e0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
 6e3:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
 6e8:	bb 00 00 00 00       	mov    $0x0,%ebx
 6ed:	eb 14                	jmp    703 <printf+0x33>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
 ...
 6f4:	e8 36 ff ff ff       	call   62f <putc>
 6f9:	eb 05                	jmp    700 <printf+0x30>
      }
    } else if(state == '%'){
 6fb:	83 fe 25             	cmp    $0x25,%esi
 6fe:	74 25                	je     725 <printf+0x55>
  for(i = 0; fmt[i]; i++){
 700:	83 c3 01             	add    $0x1,%ebx
 703:	8b 45 0c             	mov    0xc(%ebp),%eax
 706:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
 70a:	84 c0                	test   %al,%al
 70c:	0f 84 23 01 00 00    	je     835 <printf+0x165>
    c = fmt[i] & 0xff;
 712:	0f be f8             	movsbl %al,%edi
 715:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
 718:	85 f6                	test   %esi,%esi
 71a:	75 df                	jne    6fb <printf+0x2b>
      if(c == '%'){
 71c:	83 f8 25             	cmp    $0x25,%eax
 71f:	75 ce                	jne    6ef <printf+0x1f>
        state = '%';
 721:	89 c6                	mov    %eax,%esi
 723:	eb db                	jmp    700 <printf+0x30>
      if(c == 'd'){
 725:	83 f8 64             	cmp    $0x64,%eax
 728:	74 49                	je     773 <printf+0xa3>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 72a:	83 f8 78             	cmp    $0x78,%eax
 72d:	0f 94 c1             	sete   %cl
 730:	83 f8 70             	cmp    $0x70,%eax
 733:	0f 94 c2             	sete   %dl
 736:	08 d1                	or     %dl,%cl
 738:	75 63                	jne    79d <printf+0xcd>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 73a:	83 f8 73             	cmp    $0x73,%eax
 73d:	0f 84 84 00 00 00    	je     7c7 <printf+0xf7>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 743:	83 f8 63             	cmp    $0x63,%eax
 746:	0f 84 b7 00 00 00    	je     803 <printf+0x133>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 74c:	83 f8 25             	cmp    $0x25,%eax
 74f:	0f 84 cc 00 00 00    	je     821 <printf+0x151>
        putc(fd, c);
      } else {
 ...
 75d:	e8 cd fe ff ff       	call   62f <putc>
        putc(fd, c);
 762:	89 fa                	mov    %edi,%edx
 764:	8b 45 08             	mov    0x8(%ebp),%eax
 767:	e8 c3 fe ff ff       	call   62f <putc>
      }
      state = 0;
 76c:	be 00 00 00 00       	mov    $0x0,%esi
 771:	eb 8d                	jmp    700 <printf+0x30>
        printint(fd, *ap, 10, 1);
 773:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 776:	8b 17                	mov    (%edi),%edx
 778:	83 ec 0c             	sub    $0xc,%esp
 77b:	6a 01                	push   $0x1
 77d:	b9 0a 00 00 00       	mov    $0xa,%ecx
 782:	8b 45 08             	mov    0x8(%ebp),%eax
 785:	e8 bf fe ff ff       	call   649 <printint>
        ap++;
 ...
 798:	e9 63 ff ff ff       	jmp    700 <printf+0x30>
        printint(fd, *ap, 16, 0);
 79d:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 7a0:	8b 17                	mov    (%edi),%edx
 7a2:	83 ec 0c             	sub    $0xc,%esp
 7a5:	6a 00                	push   $0x0
 7a7:	b9 10 00 00 00       	mov    $0x10,%ecx
 7ac:	8b 45 08             	mov    0x8(%ebp),%eax
 7af:	e8 95 fe ff ff       	call   649 <printint>
        ap++;
 ...
 7c2:	e9 39 ff ff ff       	jmp    700 <printf+0x30>
        s = (char*)*ap;
 7c7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 7ca:	8b 30                	mov    (%eax),%esi
        ap++;
 7cc:	83 c0 04             	add    $0x4,%eax
 7cf:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
 7d2:	85 f6                	test   %esi,%esi
 7d4:	75 28                	jne    7fe <printf+0x12e>
          s = "(null)";
 7d6:	be c6 09 00 00       	mov    $0x9c6,%esi
 7db:	8b 7d 08             	mov    0x8(%ebp),%edi
 7de:	eb 0d                	jmp    7ed <printf+0x11d>
          putc(fd, *s);
 7e0:	0f be d2             	movsbl %dl,%edx
 7e3:	89 f8                	mov    %edi,%eax
 7e5:	e8 45 fe ff ff       	call   62f <putc>
          s++;
 7ea:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 7ed:	0f b6 16             	movzbl (%esi),%edx
 7f0:	84 d2                	test   %dl,%dl
 7f2:	75 ec                	jne    7e0 <printf+0x110>
      state = 0;
 7f4:	be 00 00 00 00       	mov    $0x0,%esi
 7f9:	e9 02 ff ff ff       	jmp    700 <printf+0x30>
 7fe:	8b 7d 08             	mov    0x8(%ebp),%edi
 801:	eb ea                	jmp    7ed <printf+0x11d>
        putc(fd, *ap);
 803:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 806:	0f be 17             	movsbl (%edi),%edx
 809:	8b 45 08             	mov    0x8(%ebp),%eax
 80c:	e8 1e fe ff ff       	call   62f <putc>
        ap++;
 811:	83 c7 04             	add    $0x4,%edi
 814:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 817:	be 00 00 00 00       	mov    $0x0,%esi
 81c:	e9 df fe ff ff       	jmp    700 <printf+0x30>
        putc(fd, c);
 ...
 830:	e9 cb fe ff ff       	jmp    700 <printf+0x30>
    }
  }
}
...
free(void *ap)
{
 ...
 847:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  bp = (Header*)ap - 1;
 84a:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 84d:	a1 80 0d 00 00       	mov    0xd80,%eax
 852:	eb 02                	jmp    856 <free+0x19>
 854:	89 d0                	mov    %edx,%eax
 856:	39 c8                	cmp    %ecx,%eax
 858:	73 04                	jae    85e <free+0x21>
 85a:	39 08                	cmp    %ecx,(%eax)
 85c:	77 12                	ja     870 <free+0x33>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 85e:	8b 10                	mov    (%eax),%edx
 860:	39 c2                	cmp    %eax,%edx
 862:	77 f0                	ja     854 <free+0x17>
 864:	39 c8                	cmp    %ecx,%eax
 866:	72 08                	jb     870 <free+0x33>
 868:	39 ca                	cmp    %ecx,%edx
 86a:	77 04                	ja     870 <free+0x33>
 86c:	89 d0                	mov    %edx,%eax
 86e:	eb e6                	jmp    856 <free+0x19>
      break;
  if(bp + bp->s.size == p->s.ptr){
 870:	8b 73 fc             	mov    -0x4(%ebx),%esi
 873:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
 876:	8b 10                	mov    (%eax),%edx
 878:	39 d7                	cmp    %edx,%edi
 87a:	74 19                	je     895 <free+0x58>
 ...
 885:	39 ce                	cmp    %ecx,%esi
 887:	74 1b                	je     8a4 <free+0x67>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
 889:	89 08                	mov    %ecx,(%eax)
  freep = p;
 88b:	a3 80 0d 00 00       	mov    %eax,0xd80
}
 890:	5b                   	pop    %ebx
 891:	5e                   	pop    %esi
 892:	5f                   	pop    %edi
 ...
 894:	c3                   	ret    
    bp->s.size += p->s.ptr->s.size;
 895:	03 72 04             	add    0x4(%edx),%esi
 898:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
 89b:	8b 10                	mov    (%eax),%edx
 89d:	8b 12                	mov    (%edx),%edx
 89f:	89 53 f8             	mov    %edx,-0x8(%ebx)
 8a2:	eb db                	jmp    87f <free+0x42>
    p->s.size += bp->s.size;
 8a4:	03 53 fc             	add    -0x4(%ebx),%edx
 8a7:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 8aa:	8b 53 f8             	mov    -0x8(%ebx),%edx
 8ad:	89 10                	mov    %edx,(%eax)
 8af:	eb da                	jmp    88b <free+0x4e>
...
morecore(uint nu)
{
 ...
 8b8:	89 c3                	mov    %eax,%ebx
  ...
  if(nu < 4096)
 8ba:	3d ff 0f 00 00       	cmp    $0xfff,%eax
 8bf:	77 05                	ja     8c6 <morecore+0x15>
    nu = 4096;
 8c1:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
 8c6:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 8cd:	83 ec 0c             	sub    $0xc,%esp
 8d0:	50                   	push   %eax
 8d1:	e8 f9 fc ff ff       	call   5cf <sbrk>
  if(p == (char*)-1)
 8d6:	83 c4 10             	add    $0x10,%esp
 8d9:	83 f8 ff             	cmp    $0xffffffff,%eax
 8dc:	74 1c                	je     8fa <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 8e7:	50                   	push   %eax
 8e8:	e8 50 ff ff ff       	call   83d <free>
  return freep;
 8ed:	a1 80 0d 00 00       	mov    0xd80,%eax
 ...
 8ff:	eb f4                	jmp    8f5 <morecore+0x44>
...
malloc(uint nbytes)
{
 ...
 915:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 918:	8b 0d 80 0d 00 00    	mov    0xd80,%ecx
 91e:	85 c9                	test   %ecx,%ecx
 920:	74 04                	je     926 <malloc+0x25>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 922:	8b 01                	mov    (%ecx),%eax
 924:	eb 4b                	jmp    971 <malloc+0x70>
    base.s.ptr = freep = prevp = &base;
 926:	c7 05 80 0d 00 00 84 	movl   $0xd84,0xd80
 92d:	0d 00 00 
 930:	c7 05 84 0d 00 00 84 	movl   $0xd84,0xd84
 937:	0d 00 00 
    base.s.size = 0;
 93a:	c7 05 88 0d 00 00 00 	movl   $0x0,0xd88
 941:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 944:	b9 84 0d 00 00       	mov    $0xd84,%ecx
 949:	eb d7                	jmp    922 <malloc+0x21>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
 94b:	74 1a                	je     967 <malloc+0x66>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
 ...
 955:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 958:	89 0d 80 0d 00 00    	mov    %ecx,0xd80
      return (void*)(p + 1);
 ...
 976:	73 d3                	jae    94b <malloc+0x4a>
    if(p == freep)
 978:	39 05 80 0d 00 00    	cmp    %eax,0xd80
 97e:	75 ed                	jne    96d <malloc+0x6c>
      if((p = morecore(nunits)) == 0)
 980:	89 d8                	mov    %ebx,%eax
 982:	e8 2a ff ff ff       	call   8b1 <morecore>
 987:	85 c0                	test   %eax,%eax
 989:	75 e2                	jne    96d <malloc+0x6c>
 98b:	eb d4                	jmp    961 <malloc+0x60>
