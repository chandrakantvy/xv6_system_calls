...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
      ...
      12:	68 10 11 00 00       	push   $0x1110
      17:	6a 02                	push   $0x2
      19:	e8 35 0e 00 00       	call   e53 <printf>
  memset(buf, 0, nbuf);
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
      ...
      5c:	68 ad 11 00 00       	push   $0x11ad
      61:	6a 02                	push   $0x2
      63:	e8 eb 0d 00 00       	call   e53 <printf>
  exit();
...
00000090 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      a9:	3e ff 24 85 cc 11 00 	notrack jmp *0x11cc(,%eax,4)
      b0:	00 
    exit();
      b1:	e8 14 0c 00 00       	call   cca <exit>
    panic("runcmd");
      b6:	83 ec 0c             	sub    $0xc,%esp
      b9:	68 18 11 00 00       	push   $0x1118
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      dd:	68 1f 11 00 00       	push   $0x111f
      e2:	6a 02                	push   $0x2
      e4:	e8 6a 0d 00 00       	call   e53 <printf>
    break;
  ...
  exit();
    ...
    runcmd(rcmd->cmd);
     ...
     127:	68 2f 11 00 00       	push   $0x112f
     12c:	6a 02                	push   $0x2
     12e:	e8 20 0d 00 00       	call   e53 <printf>
      exit();
    ...
    break;
     ...
     1ac:	68 3f 11 00 00       	push   $0x113f
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     245:	6a 54                	push   $0x54
     247:	e8 38 0e 00 00       	call   1084 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     273:	6a 18                	push   $0x18
     275:	e8 0a 0e 00 00       	call   1084 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     2bf:	6a 0c                	push   $0xc
     2c1:	e8 be 0d 00 00       	call   1084 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     2f9:	6a 0c                	push   $0xc
     2fb:	e8 84 0d 00 00       	call   1084 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     333:	6a 08                	push   $0x8
     335:	e8 4a 0d 00 00       	call   1084 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     37e:	50                   	push   %eax
     37f:	68 e0 17 00 00       	push   $0x17e0
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     3fa:	50                   	push   %eax
     3fb:	68 e0 17 00 00       	push   $0x17e0
     ...
     412:	50                   	push   %eax
     413:	68 d8 17 00 00       	push   $0x17d8
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     446:	50                   	push   %eax
     447:	68 e0 17 00 00       	push   $0x17e0
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     486:	50                   	push   %eax
     487:	68 e0 17 00 00       	push   $0x17e0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     4ef:	68 44 11 00 00       	push   $0x1144
  ...
  while(peek(ps, es, "<>")){
     ...
     517:	68 61 11 00 00       	push   $0x1161
     51c:	56                   	push   %esi
     51d:	57                   	push   %edi
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     5be:	68 64 11 00 00       	push   $0x1164
     5c3:	57                   	push   %edi
     5c4:	56                   	push   %esi
  ...
  return ret;
     ...
     60c:	68 66 11 00 00       	push   $0x1166
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     62c:	68 7b 11 00 00       	push   $0x117b
     631:	57                   	push   %edi
     632:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     676:	68 6d 11 00 00       	push   $0x116d
...
00000698 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     6b7:	68 80 11 00 00       	push   $0x1180
     6bc:	57                   	push   %edi
     6bd:	56                   	push   %esi
...
000006fa <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     71c:	68 82 11 00 00       	push   $0x1182
     721:	57                   	push   %edi
     722:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     74c:	68 7e 11 00 00       	push   $0x117e
     751:	57                   	push   %edi
     752:	56                   	push   %esi
...
0000078f <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     7a2:	68 64 11 00 00       	push   $0x1164
     7a7:	56                   	push   %esi
     7a8:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     7cf:	68 a0 11 00 00       	push   $0x11a0
     7d4:	56                   	push   %esi
     7d5:	53                   	push   %ebx
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     803:	68 84 11 00 00       	push   $0x1184
     808:	e8 42 f8 ff ff       	call   4f <panic>
    panic("syntax - missing )");
     80d:	83 ec 0c             	sub    $0xc,%esp
     810:	68 8f 11 00 00       	push   $0x118f
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     833:	3e ff 24 85 e4 11 00 	notrack jmp *0x11e4(,%eax,4)
     83a:	00 
...
000008b4 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     8dd:	68 2e 11 00 00       	push   $0x112e
     8e2:	53                   	push   %ebx
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     90b:	50                   	push   %eax
     90c:	68 a2 11 00 00       	push   $0x11a2
     911:	6a 02                	push   $0x2
     913:	e8 3b 05 00 00       	call   e53 <printf>
    panic("syntax");
     918:	c7 04 24 66 11 00 00 	movl   $0x1166,(%esp)
...
00000924 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     93c:	6a 02                	push   $0x2
     93e:	68 b1 11 00 00       	push   $0x11b1
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     962:	80 3d 01 18 00 00 64 	cmpb   $0x64,0x1801
     969:	75 7c                	jne    9e7 <main+0xc3>
     96b:	80 3d 02 18 00 00 20 	cmpb   $0x20,0x1802
     972:	75 73                	jne    9e7 <main+0xc3>
      buf[strlen(buf)-1] = 0;  // chop \n
     974:	83 ec 0c             	sub    $0xc,%esp
     977:	68 00 18 00 00       	push   $0x1800
     97c:	e8 07 01 00 00       	call   a88 <strlen>
     981:	c6 80 ff 17 00 00 00 	movb   $0x0,0x17ff(%eax)
      if(chdir(buf+3) < 0)
     988:	c7 04 24 03 18 00 00 	movl   $0x1803,(%esp)
     ...
     99e:	68 03 18 00 00       	push   $0x1803
     9a3:	68 b9 11 00 00       	push   $0x11b9
     9a8:	6a 02                	push   $0x2
     9aa:	e8 a4 04 00 00       	call   e53 <printf>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if ((buf[0] != '\n') && (strncmp(buf, "exit", strlen(buf)-1) == 0)) { // ignore '\n'
     ...
     9ee:	68 00 18 00 00       	push   $0x1800
     9f3:	e8 90 00 00 00       	call   a88 <strlen>
     9f8:	83 c4 0c             	add    $0xc,%esp
     9fb:	83 e8 01             	sub    $0x1,%eax
     9fe:	50                   	push   %eax
     9ff:	68 c7 11 00 00       	push   $0x11c7
     a04:	68 00 18 00 00       	push   $0x1800
     ...
     a1d:	68 00 18 00 00       	push   $0x1800
...
00000d7a <getppid>:
SYSCALL(getppid)
     d7a:	b8 18 00 00 00       	mov    $0x18,%eax
     d7f:	cd 40                	int    $0x40
     d81:	c3                   	ret    

00000d82 <getsz>:
SYSCALL(getsz)
     d82:	b8 19 00 00 00       	mov    $0x19,%eax
     d87:	cd 40                	int    $0x40
     d89:	c3                   	ret    

00000d8a <chpr>:
SYSCALL(chpr)
     d8a:	b8 1a 00 00 00       	mov    $0x1a,%eax
     d8f:	cd 40                	int    $0x40
     d91:	c3                   	ret    

00000d92 <getcount>:
SYSCALL(getcount)
     d92:	b8 1b 00 00 00       	mov    $0x1b,%eax
     d97:	cd 40                	int    $0x40
     d99:	c3                   	ret    

00000d9a <time>:
SYSCALL(time)
     d9a:	b8 1c 00 00 00       	mov    $0x1c,%eax
     d9f:	cd 40                	int    $0x40
     da1:	c3                   	ret    

00000da2 <utctime>:
SYSCALL(utctime)
     da2:	b8 1d 00 00 00       	mov    $0x1d,%eax
     da7:	cd 40                	int    $0x40
     da9:	c3                   	ret    

00000daa <dup2>:
SYSCALL(dup2)
     daa:	b8 1e 00 00 00       	mov    $0x1e,%eax
     daf:	cd 40                	int    $0x40
     db1:	c3                   	ret    
...
putc(int fd, char c)
{
     ...
     db5:	83 ec 1c             	sub    $0x1c,%esp
     db8:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
     dbb:	6a 01                	push   $0x1
     dbd:	8d 55 f4             	lea    -0xc(%ebp),%edx
     dc0:	52                   	push   %edx
     dc1:	50                   	push   %eax
     dc2:	e8 23 ff ff ff       	call   cea <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
     ...
     dd0:	56                   	push   %esi
     dd1:	53                   	push   %ebx
     dd2:	83 ec 2c             	sub    $0x2c,%esp
     dd5:	89 45 d0             	mov    %eax,-0x30(%ebp)
  ...
  neg = 0;
  if(sgn && xx < 0){
     dda:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
     dde:	0f 95 c2             	setne  %dl
     de1:	89 f0                	mov    %esi,%eax
     de3:	c1 e8 1f             	shr    $0x1f,%eax
     de6:	84 c2                	test   %al,%dl
     de8:	74 42                	je     e2c <printint+0x60>
    neg = 1;
    x = -xx;
     dea:	f7 de                	neg    %esi
    neg = 1;
     dec:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
     df3:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
     df8:	89 f0                	mov    %esi,%eax
     dfa:	ba 00 00 00 00       	mov    $0x0,%edx
     dff:	f7 f1                	div    %ecx
     e01:	89 df                	mov    %ebx,%edi
     e03:	83 c3 01             	add    $0x1,%ebx
     e06:	0f b6 92 04 12 00 00 	movzbl 0x1204(%edx),%edx
     e0d:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
     e11:	89 f2                	mov    %esi,%edx
     e13:	89 c6                	mov    %eax,%esi
     e15:	39 d1                	cmp    %edx,%ecx
     e17:	76 df                	jbe    df8 <printint+0x2c>
  if(neg)
     e19:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
     e1d:	74 2f                	je     e4e <printint+0x82>
    buf[i++] = '-';
     e1f:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
     e24:	8d 5f 02             	lea    0x2(%edi),%ebx
     e27:	8b 75 d0             	mov    -0x30(%ebp),%esi
     e2a:	eb 15                	jmp    e41 <printint+0x75>
  neg = 0;
     e2c:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
     e33:	eb be                	jmp    df3 <printint+0x27>

  while(--i >= 0)
    putc(fd, buf[i]);
     e35:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
     e3a:	89 f0                	mov    %esi,%eax
     e3c:	e8 71 ff ff ff       	call   db2 <putc>
  while(--i >= 0)
     e41:	83 eb 01             	sub    $0x1,%ebx
     e44:	79 ef                	jns    e35 <printint+0x69>
}
     e46:	83 c4 2c             	add    $0x2c,%esp
     e49:	5b                   	pop    %ebx
     e4a:	5e                   	pop    %esi
     e4b:	5f                   	pop    %edi
     e4c:	5d                   	pop    %ebp
     e4d:	c3                   	ret    
     e4e:	8b 75 d0             	mov    -0x30(%ebp),%esi
     e51:	eb ee                	jmp    e41 <printint+0x75>
...
{
     e53:	f3 0f 1e fb          	endbr32 
     e57:	55                   	push   %ebp
     e58:	89 e5                	mov    %esp,%ebp
     e5a:	57                   	push   %edi
     e5b:	56                   	push   %esi
     e5c:	53                   	push   %ebx
     e5d:	83 ec 1c             	sub    $0x1c,%esp
  char *s;
  int c, i, state;
  uint *ap;
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
     e60:	8d 45 10             	lea    0x10(%ebp),%eax
     e63:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
     e66:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
     e6b:	bb 00 00 00 00       	mov    $0x0,%ebx
     e70:	eb 14                	jmp    e86 <printf+0x33>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
     ...
     e77:	e8 36 ff ff ff       	call   db2 <putc>
     e7c:	eb 05                	jmp    e83 <printf+0x30>
      }
    } else if(state == '%'){
     e7e:	83 fe 25             	cmp    $0x25,%esi
     e81:	74 25                	je     ea8 <printf+0x55>
  for(i = 0; fmt[i]; i++){
     e83:	83 c3 01             	add    $0x1,%ebx
     e86:	8b 45 0c             	mov    0xc(%ebp),%eax
     e89:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
     e8d:	84 c0                	test   %al,%al
     e8f:	0f 84 23 01 00 00    	je     fb8 <printf+0x165>
    c = fmt[i] & 0xff;
     e95:	0f be f8             	movsbl %al,%edi
     e98:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
     e9b:	85 f6                	test   %esi,%esi
     e9d:	75 df                	jne    e7e <printf+0x2b>
      if(c == '%'){
     e9f:	83 f8 25             	cmp    $0x25,%eax
     ea2:	75 ce                	jne    e72 <printf+0x1f>
        state = '%';
     ea4:	89 c6                	mov    %eax,%esi
     ea6:	eb db                	jmp    e83 <printf+0x30>
      if(c == 'd'){
     ea8:	83 f8 64             	cmp    $0x64,%eax
     eab:	74 49                	je     ef6 <printf+0xa3>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
     ead:	83 f8 78             	cmp    $0x78,%eax
     eb0:	0f 94 c1             	sete   %cl
     eb3:	83 f8 70             	cmp    $0x70,%eax
     eb6:	0f 94 c2             	sete   %dl
     eb9:	08 d1                	or     %dl,%cl
     ebb:	75 63                	jne    f20 <printf+0xcd>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
     ebd:	83 f8 73             	cmp    $0x73,%eax
     ec0:	0f 84 84 00 00 00    	je     f4a <printf+0xf7>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
     ...
     ec6:	83 f8 63             	cmp    $0x63,%eax
     ec9:	0f 84 b7 00 00 00    	je     f86 <printf+0x133>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
     ecf:	83 f8 25             	cmp    $0x25,%eax
     ed2:	0f 84 cc 00 00 00    	je     fa4 <printf+0x151>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
     ed8:	ba 25 00 00 00       	mov    $0x25,%edx
     edd:	8b 45 08             	mov    0x8(%ebp),%eax
     ee0:	e8 cd fe ff ff       	call   db2 <putc>
        putc(fd, c);
     ee5:	89 fa                	mov    %edi,%edx
     ee7:	8b 45 08             	mov    0x8(%ebp),%eax
     eea:	e8 c3 fe ff ff       	call   db2 <putc>
      }
      state = 0;
     eef:	be 00 00 00 00       	mov    $0x0,%esi
     ef4:	eb 8d                	jmp    e83 <printf+0x30>
        printint(fd, *ap, 10, 1);
     ef6:	8b 7d e4             	mov    -0x1c(%ebp),%edi
     ef9:	8b 17                	mov    (%edi),%edx
     efb:	83 ec 0c             	sub    $0xc,%esp
     efe:	6a 01                	push   $0x1
     f00:	b9 0a 00 00 00       	mov    $0xa,%ecx
     f05:	8b 45 08             	mov    0x8(%ebp),%eax
     f08:	e8 bf fe ff ff       	call   dcc <printint>
        ap++;
     f0d:	83 c7 04             	add    $0x4,%edi
     f10:	89 7d e4             	mov    %edi,-0x1c(%ebp)
     f13:	83 c4 10             	add    $0x10,%esp
      state = 0;
     f16:	be 00 00 00 00       	mov    $0x0,%esi
     f1b:	e9 63 ff ff ff       	jmp    e83 <printf+0x30>
        printint(fd, *ap, 16, 0);
     f20:	8b 7d e4             	mov    -0x1c(%ebp),%edi
     f23:	8b 17                	mov    (%edi),%edx
     f25:	83 ec 0c             	sub    $0xc,%esp
     f28:	6a 00                	push   $0x0
     f2a:	b9 10 00 00 00       	mov    $0x10,%ecx
     f2f:	8b 45 08             	mov    0x8(%ebp),%eax
     f32:	e8 95 fe ff ff       	call   dcc <printint>
        ap++;
     f37:	83 c7 04             	add    $0x4,%edi
     f3a:	89 7d e4             	mov    %edi,-0x1c(%ebp)
     f3d:	83 c4 10             	add    $0x10,%esp
      state = 0;
     f40:	be 00 00 00 00       	mov    $0x0,%esi
     f45:	e9 39 ff ff ff       	jmp    e83 <printf+0x30>
        s = (char*)*ap;
     f4a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     f4d:	8b 30                	mov    (%eax),%esi
        ap++;
     f4f:	83 c0 04             	add    $0x4,%eax
     f52:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
     f55:	85 f6                	test   %esi,%esi
     f57:	75 28                	jne    f81 <printf+0x12e>
          s = "(null)";
     f59:	be fc 11 00 00       	mov    $0x11fc,%esi
     f5e:	8b 7d 08             	mov    0x8(%ebp),%edi
     f61:	eb 0d                	jmp    f70 <printf+0x11d>
          putc(fd, *s);
     f63:	0f be d2             	movsbl %dl,%edx
     f66:	89 f8                	mov    %edi,%eax
     f68:	e8 45 fe ff ff       	call   db2 <putc>
          s++;
     f6d:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
     f70:	0f b6 16             	movzbl (%esi),%edx
     f73:	84 d2                	test   %dl,%dl
     f75:	75 ec                	jne    f63 <printf+0x110>
      state = 0;
     f77:	be 00 00 00 00       	mov    $0x0,%esi
     f7c:	e9 02 ff ff ff       	jmp    e83 <printf+0x30>
     f81:	8b 7d 08             	mov    0x8(%ebp),%edi
     f84:	eb ea                	jmp    f70 <printf+0x11d>
        putc(fd, *ap);
     f86:	8b 7d e4             	mov    -0x1c(%ebp),%edi
     f89:	0f be 17             	movsbl (%edi),%edx
     f8c:	8b 45 08             	mov    0x8(%ebp),%eax
     f8f:	e8 1e fe ff ff       	call   db2 <putc>
        ap++;
     f94:	83 c7 04             	add    $0x4,%edi
     f97:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
     f9a:	be 00 00 00 00       	mov    $0x0,%esi
     f9f:	e9 df fe ff ff       	jmp    e83 <printf+0x30>
        putc(fd, c);
     fa4:	89 fa                	mov    %edi,%edx
     fa6:	8b 45 08             	mov    0x8(%ebp),%eax
     fa9:	e8 04 fe ff ff       	call   db2 <putc>
      state = 0;
     fae:	be 00 00 00 00       	mov    $0x0,%esi
     fb3:	e9 cb fe ff ff       	jmp    e83 <printf+0x30>
    }
  }
}
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
     fcd:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     fd0:	a1 64 18 00 00       	mov    0x1864,%eax
     fd5:	eb 02                	jmp    fd9 <free+0x19>
     fd7:	89 d0                	mov    %edx,%eax
     fd9:	39 c8                	cmp    %ecx,%eax
     fdb:	73 04                	jae    fe1 <free+0x21>
     fdd:	39 08                	cmp    %ecx,(%eax)
     fdf:	77 12                	ja     ff3 <free+0x33>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
     fe1:	8b 10                	mov    (%eax),%edx
     fe3:	39 c2                	cmp    %eax,%edx
     fe5:	77 f0                	ja     fd7 <free+0x17>
     fe7:	39 c8                	cmp    %ecx,%eax
     fe9:	72 08                	jb     ff3 <free+0x33>
     feb:	39 ca                	cmp    %ecx,%edx
     fed:	77 04                	ja     ff3 <free+0x33>
     fef:	89 d0                	mov    %edx,%eax
     ff1:	eb e6                	jmp    fd9 <free+0x19>
      break;
  if(bp + bp->s.size == p->s.ptr){
     ff3:	8b 73 fc             	mov    -0x4(%ebx),%esi
     ff6:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
     ff9:	8b 10                	mov    (%eax),%edx
     ffb:	39 d7                	cmp    %edx,%edi
     ffd:	74 19                	je     1018 <free+0x58>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
     fff:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    1002:	8b 50 04             	mov    0x4(%eax),%edx
    1005:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    1008:	39 ce                	cmp    %ecx,%esi
    100a:	74 1b                	je     1027 <free+0x67>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    100c:	89 08                	mov    %ecx,(%eax)
  freep = p;
    100e:	a3 64 18 00 00       	mov    %eax,0x1864
}
    1013:	5b                   	pop    %ebx
    1014:	5e                   	pop    %esi
    1015:	5f                   	pop    %edi
    ...
    1017:	c3                   	ret    
    bp->s.size += p->s.ptr->s.size;
    1018:	03 72 04             	add    0x4(%edx),%esi
    101b:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    101e:	8b 10                	mov    (%eax),%edx
    1020:	8b 12                	mov    (%edx),%edx
    1022:	89 53 f8             	mov    %edx,-0x8(%ebx)
    1025:	eb db                	jmp    1002 <free+0x42>
    p->s.size += bp->s.size;
    1027:	03 53 fc             	add    -0x4(%ebx),%edx
    102a:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    102d:	8b 53 f8             	mov    -0x8(%ebx),%edx
    1030:	89 10                	mov    %edx,(%eax)
    1032:	eb da                	jmp    100e <free+0x4e>
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    103d:	3d ff 0f 00 00       	cmp    $0xfff,%eax
    1042:	77 05                	ja     1049 <morecore+0x15>
    nu = 4096;
    1044:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
    1049:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    1050:	83 ec 0c             	sub    $0xc,%esp
    1053:	50                   	push   %eax
    1054:	e8 f9 fc ff ff       	call   d52 <sbrk>
  if(p == (char*)-1)
    1059:	83 c4 10             	add    $0x10,%esp
    105c:	83 f8 ff             	cmp    $0xffffffff,%eax
    105f:	74 1c                	je     107d <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    1061:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    1064:	83 c0 08             	add    $0x8,%eax
    1067:	83 ec 0c             	sub    $0xc,%esp
    106a:	50                   	push   %eax
    106b:	e8 50 ff ff ff       	call   fc0 <free>
  return freep;
    1070:	a1 64 18 00 00       	mov    0x1864,%eax
    ...
    1082:	eb f4                	jmp    1078 <morecore+0x44>
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    1092:	8d 58 07             	lea    0x7(%eax),%ebx
    1095:	c1 eb 03             	shr    $0x3,%ebx
    1098:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
    109b:	8b 0d 64 18 00 00    	mov    0x1864,%ecx
    10a1:	85 c9                	test   %ecx,%ecx
    10a3:	74 04                	je     10a9 <malloc+0x25>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    10a5:	8b 01                	mov    (%ecx),%eax
    10a7:	eb 4b                	jmp    10f4 <malloc+0x70>
    base.s.ptr = freep = prevp = &base;
    10a9:	c7 05 64 18 00 00 68 	movl   $0x1868,0x1864
    10b0:	18 00 00 
    10b3:	c7 05 68 18 00 00 68 	movl   $0x1868,0x1868
    10ba:	18 00 00 
    base.s.size = 0;
    10bd:	c7 05 6c 18 00 00 00 	movl   $0x0,0x186c
    10c4:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    10c7:	b9 68 18 00 00       	mov    $0x1868,%ecx
    10cc:	eb d7                	jmp    10a5 <malloc+0x21>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    10ce:	74 1a                	je     10ea <malloc+0x66>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    10d0:	29 da                	sub    %ebx,%edx
    10d2:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    10d5:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
    10d8:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
    10db:	89 0d 64 18 00 00    	mov    %ecx,0x1864
      return (void*)(p + 1);
    ...
    10e4:	83 c4 04             	add    $0x4,%esp
    10e7:	5b                   	pop    %ebx
    10e8:	5d                   	pop    %ebp
    10e9:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    10ea:	8b 10                	mov    (%eax),%edx
    10ec:	89 11                	mov    %edx,(%ecx)
    10ee:	eb eb                	jmp    10db <malloc+0x57>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    10f0:	89 c1                	mov    %eax,%ecx
    10f2:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
    10f4:	8b 50 04             	mov    0x4(%eax),%edx
    10f7:	39 da                	cmp    %ebx,%edx
    10f9:	73 d3                	jae    10ce <malloc+0x4a>
    if(p == freep)
    10fb:	39 05 64 18 00 00    	cmp    %eax,0x1864
    1101:	75 ed                	jne    10f0 <malloc+0x6c>
      if((p = morecore(nunits)) == 0)
    1103:	89 d8                	mov    %ebx,%eax
    1105:	e8 2a ff ff ff       	call   1034 <morecore>
    110a:	85 c0                	test   %eax,%eax
    110c:	75 e2                	jne    10f0 <malloc+0x6c>
    110e:	eb d4                	jmp    10e4 <malloc+0x60>
