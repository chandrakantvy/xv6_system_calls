...
printint(int fd, int xx, int base, int sgn)
{
 ...
 449:	0f b6 92 90 07 00 00 	movzbl 0x790(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 59a:	75 28                	jne    5c4 <printf+0x12e>
          s = "(null)";
 59c:	be 87 07 00 00       	mov    $0x787,%esi
...
free(void *ap)
{
 ...
 64f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 651:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 656:	5b                   	pop    %ebx
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 6ae:	e8 50 ff ff ff       	call   603 <free>
  return freep;
 6b3:	a1 98 0a 00 00       	mov    0xa98,%eax
...
malloc(uint nbytes)
{
 ...
 6db:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 6de:	8b 0d 98 0a 00 00    	mov    0xa98,%ecx
 ...
 6ea:	eb 4b                	jmp    737 <malloc+0x70>
    base.s.ptr = freep = prevp = &base;
 6ec:	c7 05 98 0a 00 00 9c 	movl   $0xa9c,0xa98
 6f3:	0a 00 00 
 6f6:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 6fd:	0a 00 00 
    base.s.size = 0;
 700:	c7 05 a0 0a 00 00 00 	movl   $0x0,0xaa0
 707:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 70a:	b9 9c 0a 00 00       	mov    $0xa9c,%ecx
 ...
 71b:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 71e:	89 0d 98 0a 00 00    	mov    %ecx,0xa98
      return (void*)(p + 1);
 ...
 73c:	73 d3                	jae    711 <malloc+0x4a>
    if(p == freep)
 73e:	39 05 98 0a 00 00    	cmp    %eax,0xa98
