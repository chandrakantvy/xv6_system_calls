...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       a:	68 88 3d 00 00       	push   $0x3d88
       f:	ff 35 80 5d 00 00    	pushl  0x5d80
      15:	e8 1a 3a 00 00       	call   3a34 <printf>

  if(mkdir("iputdir") < 0){
      1a:	c7 04 24 1b 3d 00 00 	movl   $0x3d1b,(%esp)
  ...
  printf(stdout, "iput test ok\n");
      ...
      6c:	68 c0 3d 00 00       	push   $0x3dc0
      71:	ff 35 80 5d 00 00    	pushl  0x5d80
      77:	e8 b8 39 00 00       	call   3a34 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
      ...
      84:	68 f4 3c 00 00       	push   $0x3cf4
      89:	ff 35 80 5d 00 00    	pushl  0x5d80
      8f:	e8 a0 39 00 00       	call   3a34 <printf>
    exit();
      94:	e8 12 38 00 00       	call   38ab <exit>
    printf(stdout, "chdir iputdir failed\n");
      99:	83 ec 08             	sub    $0x8,%esp
      9c:	68 02 3d 00 00       	push   $0x3d02
      a1:	ff 35 80 5d 00 00    	pushl  0x5d80
      a7:	e8 88 39 00 00       	call   3a34 <printf>
    exit();
      ac:	e8 fa 37 00 00       	call   38ab <exit>
    printf(stdout, "unlink ../iputdir failed\n");
      b1:	83 ec 08             	sub    $0x8,%esp
      b4:	68 23 3d 00 00       	push   $0x3d23
      b9:	ff 35 80 5d 00 00    	pushl  0x5d80
      bf:	e8 70 39 00 00       	call   3a34 <printf>
    exit();
      c4:	e8 e2 37 00 00       	call   38ab <exit>
    printf(stdout, "chdir / failed\n");
      c9:	83 ec 08             	sub    $0x8,%esp
      cc:	68 3f 3d 00 00       	push   $0x3d3f
      d1:	ff 35 80 5d 00 00    	pushl  0x5d80
      d7:	e8 58 39 00 00       	call   3a34 <printf>
    exit();
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      eb:	68 4f 3d 00 00       	push   $0x3d4f
      f0:	ff 35 80 5d 00 00    	pushl  0x5d80
      f6:	e8 39 39 00 00       	call   3a34 <printf>
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     110:	68 1b 3d 00 00       	push   $0x3d1b
    ...
    if(chdir("iputdir") < 0){
     ...
     124:	68 1b 3d 00 00       	push   $0x3d1b
    ...
    if(unlink("../iputdir") < 0){
     ...
     138:	68 18 3d 00 00       	push   $0x3d18
    ...
    printf(stdout, "fork failed\n");
     ...
     151:	68 35 4c 00 00       	push   $0x4c35
     156:	ff 35 80 5d 00 00    	pushl  0x5d80
     15c:	e8 d3 38 00 00       	call   3a34 <printf>
    exit();
     161:	e8 45 37 00 00       	call   38ab <exit>
      printf(stdout, "mkdir failed\n");
     166:	83 ec 08             	sub    $0x8,%esp
     169:	68 f4 3c 00 00       	push   $0x3cf4
     16e:	ff 35 80 5d 00 00    	pushl  0x5d80
     174:	e8 bb 38 00 00       	call   3a34 <printf>
      exit();
     179:	e8 2d 37 00 00       	call   38ab <exit>
      printf(stdout, "child chdir failed\n");
     17e:	83 ec 08             	sub    $0x8,%esp
     181:	68 5e 3d 00 00       	push   $0x3d5e
     186:	ff 35 80 5d 00 00    	pushl  0x5d80
     18c:	e8 a3 38 00 00       	call   3a34 <printf>
      exit();
     191:	e8 15 37 00 00       	call   38ab <exit>
      printf(stdout, "unlink ../iputdir failed\n");
     196:	83 ec 08             	sub    $0x8,%esp
     199:	68 23 3d 00 00       	push   $0x3d23
     19e:	ff 35 80 5d 00 00    	pushl  0x5d80
     1a4:	e8 8b 38 00 00       	call   3a34 <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1b6:	68 72 3d 00 00       	push   $0x3d72
     1bb:	ff 35 80 5d 00 00    	pushl  0x5d80
     1c1:	e8 6e 38 00 00       	call   3a34 <printf>
}
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1d5:	68 84 3d 00 00       	push   $0x3d84
     1da:	ff 35 80 5d 00 00    	pushl  0x5d80
     1e0:	e8 4f 38 00 00       	call   3a34 <printf>
  if(mkdir("oidir") < 0){
     1e5:	c7 04 24 93 3d 00 00 	movl   $0x3d93,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     206:	6a 02                	push   $0x2
     208:	68 93 3d 00 00       	push   $0x3d93
    ...
    if(fd >= 0){
     ...
     21c:	68 18 4d 00 00       	push   $0x4d18
     221:	ff 35 80 5d 00 00    	pushl  0x5d80
     227:	e8 08 38 00 00       	call   3a34 <printf>
      exit();
     22c:	e8 7a 36 00 00       	call   38ab <exit>
    printf(stdout, "mkdir oidir failed\n");
     231:	83 ec 08             	sub    $0x8,%esp
     234:	68 99 3d 00 00       	push   $0x3d99
     239:	ff 35 80 5d 00 00    	pushl  0x5d80
     23f:	e8 f0 37 00 00       	call   3a34 <printf>
    exit();
     244:	e8 62 36 00 00       	call   38ab <exit>
    printf(stdout, "fork failed\n");
     249:	83 ec 08             	sub    $0x8,%esp
     24c:	68 35 4c 00 00       	push   $0x4c35
     251:	ff 35 80 5d 00 00    	pushl  0x5d80
     257:	e8 d8 37 00 00       	call   3a34 <printf>
    exit();
  ...
  if(unlink("oidir") != 0){
     270:	c7 04 24 93 3d 00 00 	movl   $0x3d93,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     28b:	68 bc 3d 00 00       	push   $0x3dbc
     290:	ff 35 80 5d 00 00    	pushl  0x5d80
     296:	e8 99 37 00 00       	call   3a34 <printf>
}
    ...
    printf(stdout, "unlink failed\n");
     ...
     2a3:	68 ad 3d 00 00       	push   $0x3dad
     2a8:	ff 35 80 5d 00 00    	pushl  0x5d80
     2ae:	e8 81 37 00 00       	call   3a34 <printf>
    exit();
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2c2:	68 ce 3d 00 00       	push   $0x3dce
     2c7:	ff 35 80 5d 00 00    	pushl  0x5d80
     2cd:	e8 62 37 00 00       	call   3a34 <printf>
  fd = open("echo", 0);
     2d2:	83 c4 08             	add    $0x8,%esp
     2d5:	6a 00                	push   $0x0
     2d7:	68 d9 3d 00 00       	push   $0x3dd9
  ...
  fd = open("doesnotexist", 0);
     ...
     2f4:	6a 00                	push   $0x0
     2f6:	68 f1 3d 00 00       	push   $0x3df1
  ...
  printf(stdout, "open test ok\n");
     ...
     30a:	68 1c 3e 00 00       	push   $0x3e1c
     30f:	ff 35 80 5d 00 00    	pushl  0x5d80
     315:	e8 1a 37 00 00       	call   3a34 <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     ...
     322:	68 de 3d 00 00       	push   $0x3dde
     327:	ff 35 80 5d 00 00    	pushl  0x5d80
     32d:	e8 02 37 00 00       	call   3a34 <printf>
    exit();
     332:	e8 74 35 00 00       	call   38ab <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     337:	83 ec 08             	sub    $0x8,%esp
     33a:	68 fe 3d 00 00       	push   $0x3dfe
     33f:	ff 35 80 5d 00 00    	pushl  0x5d80
     345:	e8 ea 36 00 00       	call   3a34 <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     35b:	68 2a 3e 00 00       	push   $0x3e2a
     360:	ff 35 80 5d 00 00    	pushl  0x5d80
     366:	e8 c9 36 00 00       	call   3a34 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     36b:	83 c4 08             	add    $0x8,%esp
     36e:	68 02 02 00 00       	push   $0x202
     373:	68 3b 3e 00 00       	push   $0x3e3b
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     389:	68 41 3e 00 00       	push   $0x3e41
     38e:	ff 35 80 5d 00 00    	pushl  0x5d80
     394:	e8 9b 36 00 00       	call   3a34 <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3a9:	6a 0a                	push   $0xa
     3ab:	68 78 3e 00 00       	push   $0x3e78
     3b0:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     3c1:	6a 0a                	push   $0xa
     3c3:	68 83 3e 00 00       	push   $0x3e83
     3c8:	56                   	push   %esi
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3de:	68 5c 3e 00 00       	push   $0x3e5c
     3e3:	ff 35 80 5d 00 00    	pushl  0x5d80
     3e9:	e8 46 36 00 00       	call   3a34 <printf>
    exit();
     3ee:	e8 b8 34 00 00       	call   38ab <exit>
      printf(stdout, "error: write aa %d new file failed\n", i);
     3f3:	83 ec 04             	sub    $0x4,%esp
     3f6:	53                   	push   %ebx
     3f7:	68 3c 4d 00 00       	push   $0x4d3c
     3fc:	ff 35 80 5d 00 00    	pushl  0x5d80
     402:	e8 2d 36 00 00       	call   3a34 <printf>
      exit();
     407:	e8 9f 34 00 00       	call   38ab <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     40c:	83 ec 04             	sub    $0x4,%esp
     40f:	53                   	push   %ebx
     410:	68 60 4d 00 00       	push   $0x4d60
     415:	ff 35 80 5d 00 00    	pushl  0x5d80
     41b:	e8 14 36 00 00       	call   3a34 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     428:	68 8e 3e 00 00       	push   $0x3e8e
     42d:	ff 35 80 5d 00 00    	pushl  0x5d80
     433:	e8 fc 35 00 00       	call   3a34 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     443:	6a 00                	push   $0x0
     445:	68 3b 3e 00 00       	push   $0x3e3b
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     45b:	68 99 3e 00 00       	push   $0x3e99
     460:	ff 35 80 5d 00 00    	pushl  0x5d80
     466:	e8 c9 35 00 00       	call   3a34 <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     48b:	68 cd 3e 00 00       	push   $0x3ecd
     490:	ff 35 80 5d 00 00    	pushl  0x5d80
     496:	e8 99 35 00 00       	call   3a34 <printf>
  } else {
  ...
  if(unlink("small") < 0){
     4a3:	c7 04 24 3b 3e 00 00 	movl   $0x3e3b,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     4b9:	68 f5 3e 00 00       	push   $0x3ef5
     4be:	ff 35 80 5d 00 00    	pushl  0x5d80
     4c4:	e8 6b 35 00 00       	call   3a34 <printf>
}
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     4d6:	68 b2 3e 00 00       	push   $0x3eb2
     4db:	ff 35 80 5d 00 00    	pushl  0x5d80
     4e1:	e8 4e 35 00 00       	call   3a34 <printf>
    exit();
     4e6:	e8 c0 33 00 00       	call   38ab <exit>
    printf(stdout, "read failed\n");
     4eb:	83 ec 08             	sub    $0x8,%esp
     4ee:	68 f9 41 00 00       	push   $0x41f9
     4f3:	ff 35 80 5d 00 00    	pushl  0x5d80
     4f9:	e8 36 35 00 00       	call   3a34 <printf>
    exit();
     4fe:	e8 a8 33 00 00       	call   38ab <exit>
    printf(stdout, "unlink small failed\n");
     503:	83 ec 08             	sub    $0x8,%esp
     506:	68 e0 3e 00 00       	push   $0x3ee0
     50b:	ff 35 80 5d 00 00    	pushl  0x5d80
     511:	e8 1e 35 00 00       	call   3a34 <printf>
    exit();
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     527:	68 09 3f 00 00       	push   $0x3f09
     52c:	ff 35 80 5d 00 00    	pushl  0x5d80
     532:	e8 fd 34 00 00       	call   3a34 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     537:	83 c4 08             	add    $0x8,%esp
     53a:	68 02 02 00 00       	push   $0x202
     53f:	68 83 3f 00 00       	push   $0x3f83
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     58a:	68 19 3f 00 00       	push   $0x3f19
     58f:	ff 35 80 5d 00 00    	pushl  0x5d80
     595:	e8 9a 34 00 00       	call   3a34 <printf>
    exit();
     59a:	e8 0c 33 00 00       	call   38ab <exit>
      printf(stdout, "error: write big file failed\n", i);
     59f:	83 ec 04             	sub    $0x4,%esp
     5a2:	53                   	push   %ebx
     5a3:	68 33 3f 00 00       	push   $0x3f33
     5a8:	ff 35 80 5d 00 00    	pushl  0x5d80
     5ae:	e8 81 34 00 00       	call   3a34 <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     5c4:	6a 00                	push   $0x0
     5c6:	68 83 3f 00 00       	push   $0x3f83
  ...
  for(;;){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     618:	68 51 3f 00 00       	push   $0x3f51
     61d:	ff 35 80 5d 00 00    	pushl  0x5d80
     623:	e8 0c 34 00 00       	call   3a34 <printf>
    exit();
  ...
  if(unlink("big") < 0){
     63e:	c7 04 24 83 3f 00 00 	movl   $0x3f83,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     654:	68 aa 3f 00 00       	push   $0x3faa
     659:	ff 35 80 5d 00 00    	pushl  0x5d80
     65f:	e8 d0 33 00 00       	call   3a34 <printf>
}
     ...
     671:	53                   	push   %ebx
     672:	68 6a 3f 00 00       	push   $0x3f6a
     677:	ff 35 80 5d 00 00    	pushl  0x5d80
     67d:	e8 b2 33 00 00       	call   3a34 <printf>
        exit();
     682:	e8 24 32 00 00       	call   38ab <exit>
      printf(stdout, "read failed %d\n", i);
     687:	83 ec 04             	sub    $0x4,%esp
     68a:	50                   	push   %eax
     68b:	68 87 3f 00 00       	push   $0x3f87
     690:	ff 35 80 5d 00 00    	pushl  0x5d80
     696:	e8 99 33 00 00       	call   3a34 <printf>
      exit();
     69b:	e8 0b 32 00 00       	call   38ab <exit>
      printf(stdout, "read content of block %d is %d\n",
     6a0:	50                   	push   %eax
     6a1:	53                   	push   %ebx
     6a2:	68 84 4d 00 00       	push   $0x4d84
     6a7:	ff 35 80 5d 00 00    	pushl  0x5d80
     6ad:	e8 82 33 00 00       	call   3a34 <printf>
      exit();
     6b2:	e8 f4 31 00 00       	call   38ab <exit>
    printf(stdout, "unlink big failed\n");
     6b7:	83 ec 08             	sub    $0x8,%esp
     6ba:	68 97 3f 00 00       	push   $0x3f97
     6bf:	ff 35 80 5d 00 00    	pushl  0x5d80
     6c5:	e8 6a 33 00 00       	call   3a34 <printf>
    exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     6da:	68 a4 4d 00 00       	push   $0x4da4
     6df:	ff 35 80 5d 00 00    	pushl  0x5d80
     6e5:	e8 4a 33 00 00       	call   3a34 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     767:	68 cc 4d 00 00       	push   $0x4dcc
     76c:	ff 35 80 5d 00 00    	pushl  0x5d80
     772:	e8 bd 32 00 00       	call   3a34 <printf>
}
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     789:	68 b8 3f 00 00       	push   $0x3fb8
     78e:	ff 35 80 5d 00 00    	pushl  0x5d80
     794:	e8 9b 32 00 00       	call   3a34 <printf>

  if(mkdir("dir0") < 0){
     799:	c7 04 24 c4 3f 00 00 	movl   $0x3fc4,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     7af:	68 c4 3f 00 00       	push   $0x3fc4
  ...
  if(chdir("..") < 0){
     ...
     7c3:	68 69 45 00 00       	push   $0x4569
  ...
  if(unlink("dir0") < 0){
     ...
     7d7:	68 c4 3f 00 00       	push   $0x3fc4
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     7eb:	68 01 40 00 00       	push   $0x4001
     7f0:	ff 35 80 5d 00 00    	pushl  0x5d80
     7f6:	e8 39 32 00 00       	call   3a34 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     803:	68 f4 3c 00 00       	push   $0x3cf4
     808:	ff 35 80 5d 00 00    	pushl  0x5d80
     80e:	e8 21 32 00 00       	call   3a34 <printf>
    exit();
     813:	e8 93 30 00 00       	call   38ab <exit>
    printf(stdout, "chdir dir0 failed\n");
     818:	83 ec 08             	sub    $0x8,%esp
     81b:	68 c9 3f 00 00       	push   $0x3fc9
     820:	ff 35 80 5d 00 00    	pushl  0x5d80
     826:	e8 09 32 00 00       	call   3a34 <printf>
    exit();
     82b:	e8 7b 30 00 00       	call   38ab <exit>
    printf(stdout, "chdir .. failed\n");
     830:	83 ec 08             	sub    $0x8,%esp
     833:	68 dc 3f 00 00       	push   $0x3fdc
     838:	ff 35 80 5d 00 00    	pushl  0x5d80
     83e:	e8 f1 31 00 00       	call   3a34 <printf>
    exit();
     843:	e8 63 30 00 00       	call   38ab <exit>
    printf(stdout, "unlink dir0 failed\n");
     848:	83 ec 08             	sub    $0x8,%esp
     84b:	68 ed 3f 00 00       	push   $0x3fed
     850:	ff 35 80 5d 00 00    	pushl  0x5d80
     856:	e8 d9 31 00 00       	call   3a34 <printf>
    exit();
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     86a:	68 10 40 00 00       	push   $0x4010
     86f:	ff 35 80 5d 00 00    	pushl  0x5d80
     875:	e8 ba 31 00 00       	call   3a34 <printf>
  if(exec("echo", echoargv) < 0){
     87a:	83 c4 08             	add    $0x8,%esp
     87d:	68 84 5d 00 00       	push   $0x5d84
     882:	68 d9 3d 00 00       	push   $0x3dd9
    ...
    printf(stdout, "exec echo failed\n");
     ...
     898:	68 1b 40 00 00       	push   $0x401b
     89d:	ff 35 80 5d 00 00    	pushl  0x5d80
     8a3:	e8 8c 31 00 00       	call   3a34 <printf>
    exit();
...
pipe1(void)
{
  ...
  seq = 0;
    ...
    printf(1, "pipe() failed\n");
     ...
     941:	68 2d 40 00 00       	push   $0x402d
     946:	6a 01                	push   $0x1
     948:	e8 e7 30 00 00       	call   3a34 <printf>
    exit();
  ...
  seq = 0;
    ...
    for(n = 0; n < 5; n++){
     ...
     9a7:	68 3c 40 00 00       	push   $0x403c
     9ac:	6a 01                	push   $0x1
     9ae:	e8 81 30 00 00       	call   3a34 <printf>
        exit();
    ...
    exit();
     ...
     9c0:	68 4a 40 00 00       	push   $0x404a
     9c5:	6a 01                	push   $0x1
     9c7:	e8 68 30 00 00       	call   3a34 <printf>
          return;
  ...
  printf(1, "pipe1 ok\n");
     ...
     a15:	68 6f 40 00 00       	push   $0x406f
     a1a:	6a 01                	push   $0x1
     a1c:	e8 13 30 00 00       	call   3a34 <printf>
     a21:	83 c4 10             	add    $0x10,%esp
     a24:	eb a9                	jmp    9cf <pipe1+0x122>
      printf(1, "pipe1 oops 3 total %d\n", total);
     a26:	83 ec 04             	sub    $0x4,%esp
     a29:	ff 75 d0             	pushl  -0x30(%ebp)
     a2c:	68 58 40 00 00       	push   $0x4058
     a31:	6a 01                	push   $0x1
     a33:	e8 fc 2f 00 00       	call   3a34 <printf>
      exit();
     a38:	e8 6e 2e 00 00       	call   38ab <exit>
    printf(1, "fork() failed\n");
     a3d:	83 ec 08             	sub    $0x8,%esp
     a40:	68 79 40 00 00       	push   $0x4079
     a45:	6a 01                	push   $0x1
     a47:	e8 e8 2f 00 00       	call   3a34 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     a5e:	68 88 40 00 00       	push   $0x4088
     a63:	6a 01                	push   $0x1
     a65:	e8 ca 2f 00 00       	call   3a34 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     aaf:	6a 01                	push   $0x1
     ab1:	68 4d 46 00 00       	push   $0x464d
    ...
    for(;;)
     ...
     ad9:	68 92 40 00 00       	push   $0x4092
     ade:	6a 01                	push   $0x1
     ae0:	e8 4f 2f 00 00       	call   3a34 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     b15:	68 a6 40 00 00       	push   $0x40a6
     b1a:	6a 01                	push   $0x1
     b1c:	e8 13 2f 00 00       	call   3a34 <printf>
    return;
  ...
  printf(1, "kill... ");
     ...
     b3a:	68 b9 40 00 00       	push   $0x40b9
     b3f:	6a 01                	push   $0x1
     b41:	e8 ee 2e 00 00       	call   3a34 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     b61:	68 c2 40 00 00       	push   $0x40c2
     b66:	6a 01                	push   $0x1
     b68:	e8 c7 2e 00 00       	call   3a34 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     b7f:	68 cb 40 00 00       	push   $0x40cb
     b84:	6a 01                	push   $0x1
     b86:	e8 a9 2e 00 00       	call   3a34 <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     ba3:	68 35 4c 00 00       	push   $0x4c35
     ba8:	6a 01                	push   $0x1
     baa:	e8 85 2e 00 00       	call   3a34 <printf>
      return;
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid){
     ...
     bdf:	68 d7 40 00 00       	push   $0x40d7
     be4:	6a 01                	push   $0x1
     be6:	e8 49 2e 00 00       	call   3a34 <printf>
        return;
     beb:	83 c4 10             	add    $0x10,%esp
     bee:	eb c2                	jmp    bb2 <exitwait+0x22>
  printf(1, "exitwait ok\n");
     bf0:	83 ec 08             	sub    $0x8,%esp
     bf3:	68 e7 40 00 00       	push   $0x40e7
     bf8:	6a 01                	push   $0x1
     bfa:	e8 35 2e 00 00       	call   3a34 <printf>
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     c11:	68 f4 40 00 00       	push   $0x40f4
     c16:	6a 01                	push   $0x1
     c18:	e8 17 2e 00 00       	call   3a34 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     c41:	e8 1f 30 00 00       	call   3c65 <malloc>
    ...
    while(m1){
     ...
     c58:	53                   	push   %ebx
     c59:	e8 43 2f 00 00       	call   3ba1 <free>
    ...
    m1 = malloc(1024*20);
     ...
     c6f:	e8 f1 2f 00 00       	call   3c65 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     c7e:	50                   	push   %eax
     c7f:	e8 1d 2f 00 00       	call   3ba1 <free>
    printf(1, "mem ok\n");
     c84:	83 c4 08             	add    $0x8,%esp
     c87:	68 18 41 00 00       	push   $0x4118
     c8c:	6a 01                	push   $0x1
     c8e:	e8 a1 2d 00 00       	call   3a34 <printf>
    exit();
     c93:	e8 13 2c 00 00       	call   38ab <exit>
      printf(1, "couldn't allocate mem?!!\n");
     c98:	83 ec 08             	sub    $0x8,%esp
     c9b:	68 fe 40 00 00       	push   $0x40fe
     ca0:	6a 01                	push   $0x1
     ca2:	e8 8d 2d 00 00       	call   3a34 <printf>
      kill(ppid);
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     cce:	68 20 41 00 00       	push   $0x4120
     cd3:	6a 01                	push   $0x1
     cd5:	e8 5a 2d 00 00       	call   3a34 <printf>

  unlink("sharedfd");
     cda:	c7 04 24 2f 41 00 00 	movl   $0x412f,(%esp)
     ce1:	e8 15 2c 00 00       	call   38fb <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     ce6:	83 c4 08             	add    $0x8,%esp
     ce9:	68 02 02 00 00       	push   $0x202
     cee:	68 2f 41 00 00       	push   $0x412f
  ...
  for(i = 0; i < 1000; i++){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     d4f:	68 f4 4d 00 00       	push   $0x4df4
     d54:	6a 01                	push   $0x1
     d56:	e8 d9 2c 00 00       	call   3a34 <printf>
    return;
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     d6d:	68 20 4e 00 00       	push   $0x4e20
     d72:	6a 01                	push   $0x1
     d74:	e8 bb 2c 00 00       	call   3a34 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     d91:	6a 00                	push   $0x0
     d93:	68 2f 41 00 00       	push   $0x412f
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     dd5:	68 40 4e 00 00       	push   $0x4e40
     dda:	6a 01                	push   $0x1
     ddc:	e8 53 2c 00 00       	call   3a34 <printf>
    return;
  ...
  unlink("sharedfd");
     e10:	c7 04 24 2f 41 00 00 	movl   $0x412f,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     e38:	68 38 41 00 00       	push   $0x4138
     e3d:	6a 01                	push   $0x1
     e3f:	e8 f0 2b 00 00       	call   3a34 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     e4f:	56                   	push   %esi
     e50:	53                   	push   %ebx
     e51:	68 45 41 00 00       	push   $0x4145
     e56:	6a 01                	push   $0x1
     e58:	e8 d7 2b 00 00       	call   3a34 <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
     e6f:	c7 45 d8 5a 41 00 00 	movl   $0x415a,-0x28(%ebp)
     e76:	c7 45 dc a3 42 00 00 	movl   $0x42a3,-0x24(%ebp)
     e7d:	c7 45 e0 a7 42 00 00 	movl   $0x42a7,-0x20(%ebp)
     e84:	c7 45 e4 5d 41 00 00 	movl   $0x415d,-0x1c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
     e8b:	68 60 41 00 00       	push   $0x4160
     e90:	6a 01                	push   $0x1
     e92:	e8 9d 2b 00 00       	call   3a34 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
     ...
     ecb:	68 35 4c 00 00       	push   $0x4c35
     ed0:	6a 01                	push   $0x1
     ed2:	e8 5d 2b 00 00       	call   3a34 <printf>
      exit();
     ...
     f38:	68 fb 43 00 00       	push   $0x43fb
     f3d:	6a 01                	push   $0x1
     f3f:	e8 f0 2a 00 00       	call   3a34 <printf>
        exit();
     f44:	e8 62 29 00 00       	call   38ab <exit>
          printf(1, "write failed %d\n", n);
     f49:	83 ec 04             	sub    $0x4,%esp
     f4c:	50                   	push   %eax
     f4d:	68 70 41 00 00       	push   $0x4170
     f52:	6a 01                	push   $0x1
     f54:	e8 db 2a 00 00       	call   3a34 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f81:	68 81 41 00 00       	push   $0x4181
     f86:	6a 01                	push   $0x1
     f88:	e8 a7 2a 00 00       	call   3a34 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    101d:	56                   	push   %esi
    101e:	68 8d 41 00 00       	push   $0x418d
    1023:	6a 01                	push   $0x1
    1025:	e8 0a 2a 00 00       	call   3a34 <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    ...
    1032:	68 9e 41 00 00       	push   $0x419e
    1037:	6a 01                	push   $0x1
    1039:	e8 f6 29 00 00       	call   3a34 <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1055:	68 ac 41 00 00       	push   $0x41ac
    105a:	6a 01                	push   $0x1
    105c:	e8 d3 29 00 00       	call   3a34 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1087:	68 35 4c 00 00       	push   $0x4c35
    108c:	6a 01                	push   $0x1
    108e:	e8 a1 29 00 00       	call   3a34 <printf>
      exit();
    ...
    10a7:	68 fb 43 00 00       	push   $0x43fb
    10ac:	6a 01                	push   $0x1
    10ae:	e8 81 29 00 00       	call   3a34 <printf>
          exit();
    ...
    1118:	68 ad 3d 00 00       	push   $0x3dad
    111d:	6a 01                	push   $0x1
    111f:	e8 10 29 00 00       	call   3a34 <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    11a2:	50                   	push   %eax
    11a3:	68 6c 4e 00 00       	push   $0x4e6c
    11a8:	6a 01                	push   $0x1
    11aa:	e8 85 28 00 00       	call   3a34 <printf>
        exit();
    ...
    11be:	50                   	push   %eax
    11bf:	68 90 4e 00 00       	push   $0x4e90
    11c4:	6a 01                	push   $0x1
    11c6:	e8 69 28 00 00       	call   3a34 <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    ...
    122c:	68 bf 41 00 00       	push   $0x41bf
    1231:	6a 01                	push   $0x1
    1233:	e8 fc 27 00 00       	call   3a34 <printf>
}
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    124e:	68 d0 41 00 00       	push   $0x41d0
    1253:	6a 01                	push   $0x1
    1255:	e8 da 27 00 00       	call   3a34 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    125a:	83 c4 08             	add    $0x8,%esp
    125d:	68 02 02 00 00       	push   $0x202
    1262:	68 e1 41 00 00       	push   $0x41e1
  ...
  write(fd, "hello", 5);
    ...
    127c:	6a 05                	push   $0x5
    127e:	68 06 42 00 00       	push   $0x4206
    1283:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1294:	6a 02                	push   $0x2
    1296:	68 e1 41 00 00       	push   $0x41e1
  ...
  if(unlink("unlinkread") != 0){
    ...
    12b0:	68 e1 41 00 00       	push   $0x41e1
  ...
  unlink("unlinkread");
    1342:	c7 04 24 e1 41 00 00 	movl   $0x41e1,(%esp)
    1349:	e8 ad 25 00 00       	call   38fb <unlink>
  printf(1, "unlinkread ok\n");
    134e:	83 c4 08             	add    $0x8,%esp
    1351:	68 89 42 00 00       	push   $0x4289
    1356:	6a 01                	push   $0x1
    1358:	e8 d7 26 00 00       	call   3a34 <printf>
}
    ...
    136a:	68 ec 41 00 00       	push   $0x41ec
    136f:	6a 01                	push   $0x1
    1371:	e8 be 26 00 00       	call   3a34 <printf>
    exit();
    1376:	e8 30 25 00 00       	call   38ab <exit>
    printf(1, "open unlinkread failed\n");
    137b:	83 ec 08             	sub    $0x8,%esp
    137e:	68 0c 42 00 00       	push   $0x420c
    1383:	6a 01                	push   $0x1
    1385:	e8 aa 26 00 00       	call   3a34 <printf>
    exit();
    138a:	e8 1c 25 00 00       	call   38ab <exit>
    printf(1, "unlink unlinkread failed\n");
    138f:	83 ec 08             	sub    $0x8,%esp
    1392:	68 24 42 00 00       	push   $0x4224
    1397:	6a 01                	push   $0x1
    1399:	e8 96 26 00 00       	call   3a34 <printf>
    exit();
    139e:	e8 08 25 00 00       	call   38ab <exit>
    printf(1, "unlinkread read failed");
    13a3:	83 ec 08             	sub    $0x8,%esp
    13a6:	68 42 42 00 00       	push   $0x4242
    13ab:	6a 01                	push   $0x1
    13ad:	e8 82 26 00 00       	call   3a34 <printf>
    exit();
    13b2:	e8 f4 24 00 00       	call   38ab <exit>
    printf(1, "unlinkread wrong data\n");
    13b7:	83 ec 08             	sub    $0x8,%esp
    13ba:	68 59 42 00 00       	push   $0x4259
    13bf:	6a 01                	push   $0x1
    13c1:	e8 6e 26 00 00       	call   3a34 <printf>
    exit();
    13c6:	e8 e0 24 00 00       	call   38ab <exit>
    printf(1, "unlinkread write failed\n");
    13cb:	83 ec 08             	sub    $0x8,%esp
    13ce:	68 70 42 00 00       	push   $0x4270
    13d3:	6a 01                	push   $0x1
    13d5:	e8 5a 26 00 00       	call   3a34 <printf>
    exit();
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    13ea:	68 98 42 00 00       	push   $0x4298
    13ef:	6a 01                	push   $0x1
    13f1:	e8 3e 26 00 00       	call   3a34 <printf>

  unlink("lf1");
    13f6:	c7 04 24 a2 42 00 00 	movl   $0x42a2,(%esp)
    13fd:	e8 f9 24 00 00       	call   38fb <unlink>
  unlink("lf2");
    1402:	c7 04 24 a6 42 00 00 	movl   $0x42a6,(%esp)
    1409:	e8 ed 24 00 00       	call   38fb <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    140e:	83 c4 08             	add    $0x8,%esp
    1411:	68 02 02 00 00       	push   $0x202
    1416:	68 a2 42 00 00       	push   $0x42a2
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1430:	6a 05                	push   $0x5
    1432:	68 06 42 00 00       	push   $0x4206
    1437:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    ...
    1455:	68 a6 42 00 00       	push   $0x42a6
    145a:	68 a2 42 00 00       	push   $0x42a2
  ...
  unlink("lf1");
    ...
    1472:	68 a2 42 00 00       	push   $0x42a2
    1477:	e8 7f 24 00 00       	call   38fb <unlink>

  if(open("lf1", 0) >= 0){
    147c:	83 c4 08             	add    $0x8,%esp
    147f:	6a 00                	push   $0x0
    1481:	68 a2 42 00 00       	push   $0x42a2
  ...
  fd = open("lf2", 0);
    ...
    1499:	6a 00                	push   $0x0
    149b:	68 a6 42 00 00       	push   $0x42a6
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    14dd:	68 a6 42 00 00       	push   $0x42a6
    14e2:	68 a6 42 00 00       	push   $0x42a6
  ...
  unlink("lf2");
    ...
    14fa:	68 a6 42 00 00       	push   $0x42a6
    14ff:	e8 f7 23 00 00       	call   38fb <unlink>
  if(link("lf2", "lf1") >= 0){
    1504:	83 c4 08             	add    $0x8,%esp
    1507:	68 a2 42 00 00       	push   $0x42a2
    150c:	68 a6 42 00 00       	push   $0x42a6
  ...
  if(link(".", "lf1") >= 0){
    ...
    1524:	68 a2 42 00 00       	push   $0x42a2
    1529:	68 6a 45 00 00       	push   $0x456a
  ...
  printf(1, "linktest ok\n");
    ...
    1541:	68 40 43 00 00       	push   $0x4340
    1546:	6a 01                	push   $0x1
    1548:	e8 e7 24 00 00       	call   3a34 <printf>
}
    ...
    1558:	68 aa 42 00 00       	push   $0x42aa
    155d:	6a 01                	push   $0x1
    155f:	e8 d0 24 00 00       	call   3a34 <printf>
    exit();
    1564:	e8 42 23 00 00       	call   38ab <exit>
    printf(1, "write lf1 failed\n");
    1569:	83 ec 08             	sub    $0x8,%esp
    156c:	68 bd 42 00 00       	push   $0x42bd
    1571:	6a 01                	push   $0x1
    1573:	e8 bc 24 00 00       	call   3a34 <printf>
    exit();
    1578:	e8 2e 23 00 00       	call   38ab <exit>
    printf(1, "link lf1 lf2 failed\n");
    157d:	83 ec 08             	sub    $0x8,%esp
    1580:	68 cf 42 00 00       	push   $0x42cf
    1585:	6a 01                	push   $0x1
    1587:	e8 a8 24 00 00       	call   3a34 <printf>
    exit();
    158c:	e8 1a 23 00 00       	call   38ab <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    1591:	83 ec 08             	sub    $0x8,%esp
    1594:	68 b0 4e 00 00       	push   $0x4eb0
    1599:	6a 01                	push   $0x1
    159b:	e8 94 24 00 00       	call   3a34 <printf>
    exit();
    15a0:	e8 06 23 00 00       	call   38ab <exit>
    printf(1, "open lf2 failed\n");
    15a5:	83 ec 08             	sub    $0x8,%esp
    15a8:	68 e4 42 00 00       	push   $0x42e4
    15ad:	6a 01                	push   $0x1
    15af:	e8 80 24 00 00       	call   3a34 <printf>
    exit();
    15b4:	e8 f2 22 00 00       	call   38ab <exit>
    printf(1, "read lf2 failed\n");
    15b9:	83 ec 08             	sub    $0x8,%esp
    15bc:	68 f5 42 00 00       	push   $0x42f5
    15c1:	6a 01                	push   $0x1
    15c3:	e8 6c 24 00 00       	call   3a34 <printf>
    exit();
    15c8:	e8 de 22 00 00       	call   38ab <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15cd:	83 ec 08             	sub    $0x8,%esp
    15d0:	68 06 43 00 00       	push   $0x4306
    15d5:	6a 01                	push   $0x1
    15d7:	e8 58 24 00 00       	call   3a34 <printf>
    exit();
    15dc:	e8 ca 22 00 00       	call   38ab <exit>
    printf(1, "link non-existant succeeded! oops\n");
    15e1:	83 ec 08             	sub    $0x8,%esp
    15e4:	68 d8 4e 00 00       	push   $0x4ed8
    15e9:	6a 01                	push   $0x1
    15eb:	e8 44 24 00 00       	call   3a34 <printf>
    exit();
    15f0:	e8 b6 22 00 00       	call   38ab <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    15f5:	83 ec 08             	sub    $0x8,%esp
    15f8:	68 24 43 00 00       	push   $0x4324
    15fd:	6a 01                	push   $0x1
    15ff:	e8 30 24 00 00       	call   3a34 <printf>
    exit();
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1616:	68 4d 43 00 00       	push   $0x434d
    161b:	6a 01                	push   $0x1
    161d:	e8 12 24 00 00       	call   3a34 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16e5:	50                   	push   %eax
    16e6:	68 5d 43 00 00       	push   $0x435d
    ...
    16fb:	50                   	push   %eax
    16fc:	68 5d 43 00 00       	push   $0x435d
    ...
    1714:	50                   	push   %eax
    1715:	68 60 43 00 00       	push   $0x4360
    171a:	6a 01                	push   $0x1
    171c:	e8 13 23 00 00       	call   3a34 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    173e:	6a 00                	push   $0x0
    1740:	68 6a 45 00 00       	push   $0x456a
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    17a0:	50                   	push   %eax
    17a1:	68 7c 43 00 00       	push   $0x437c
    17a6:	6a 01                	push   $0x1
    17a8:	e8 87 22 00 00       	call   3a34 <printf>
        exit();
    ...
    17b8:	50                   	push   %eax
    17b9:	68 95 43 00 00       	push   $0x4395
    17be:	6a 01                	push   $0x1
    17c0:	e8 6f 22 00 00       	call   3a34 <printf>
        exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    17e8:	68 fc 4e 00 00       	push   $0x4efc
    17ed:	6a 01                	push   $0x1
    17ef:	e8 40 22 00 00       	call   3a34 <printf>
    exit();
    ...
    17fc:	68 35 4c 00 00       	push   $0x4c35
    1801:	6a 01                	push   $0x1
    1803:	e8 2c 22 00 00       	call   3a34 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    ...
    18e4:	68 b2 43 00 00       	push   $0x43b2
    18e9:	6a 01                	push   $0x1
    18eb:	e8 44 21 00 00       	call   3a34 <printf>
}
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1908:	68 c0 43 00 00       	push   $0x43c0
    190d:	6a 01                	push   $0x1
    190f:	e8 20 21 00 00       	call   3a34 <printf>

  unlink("x");
    1914:	c7 04 24 4d 46 00 00 	movl   $0x464d,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    193f:	68 35 4c 00 00       	push   $0x4c35
    1944:	6a 01                	push   $0x1
    1946:	e8 e9 20 00 00       	call   3a34 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    195f:	68 4d 46 00 00       	push   $0x464d
    ...
    1979:	68 4d 46 00 00       	push   $0x464d
  ...
  for(i = 0; i < 100; i++){
    ...
    19ba:	68 4d 46 00 00       	push   $0x464d
    19bf:	68 d1 43 00 00       	push   $0x43d1
  ...
  printf(1, "linkunlink ok\n");
    ...
    19da:	68 d5 43 00 00       	push   $0x43d5
    19df:	6a 01                	push   $0x1
    19e1:	e8 4e 20 00 00       	call   3a34 <printf>
}
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    19fe:	68 e4 43 00 00       	push   $0x43e4
    1a03:	6a 01                	push   $0x1
    1a05:	e8 2a 20 00 00       	call   3a34 <printf>
  unlink("bd");
    1a0a:	c7 04 24 f1 43 00 00 	movl   $0x43f1,(%esp)
    1a11:	e8 e5 1e 00 00       	call   38fb <unlink>

  fd = open("bd", O_CREATE);
    1a16:	83 c4 08             	add    $0x8,%esp
    1a19:	68 00 02 00 00       	push   $0x200
    1a1e:	68 f1 43 00 00       	push   $0x43f1
  ...
  for(i = 0; i < 500; i++){
    ...
    1a7d:	50                   	push   %eax
    1a7e:	68 f1 43 00 00       	push   $0x43f1
  ...
  for(i = 0; i < 500; i++){
    ...
    1a97:	68 f4 43 00 00       	push   $0x43f4
    1a9c:	6a 01                	push   $0x1
    1a9e:	e8 91 1f 00 00       	call   3a34 <printf>
    exit();
    1aa3:	e8 03 1e 00 00       	call   38ab <exit>
      printf(1, "bigdir link failed\n");
    1aa8:	83 ec 08             	sub    $0x8,%esp
    1aab:	68 0a 44 00 00       	push   $0x440a
    1ab0:	6a 01                	push   $0x1
    1ab2:	e8 7d 1f 00 00       	call   3a34 <printf>
      exit();
  ...
  unlink("bd");
    ...
    1abf:	68 f1 43 00 00       	push   $0x43f1
  ...
  for(i = 0; i < 500; i++){
    ...
    1b23:	68 1e 44 00 00       	push   $0x441e
    1b28:	6a 01                	push   $0x1
    1b2a:	e8 05 1f 00 00       	call   3a34 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    ...
    1b37:	68 33 44 00 00       	push   $0x4433
    1b3c:	6a 01                	push   $0x1
    1b3e:	e8 f1 1e 00 00       	call   3a34 <printf>
}
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1b56:	68 3e 44 00 00       	push   $0x443e
    1b5b:	6a 01                	push   $0x1
    1b5d:	e8 d2 1e 00 00       	call   3a34 <printf>

  unlink("ff");
    1b62:	c7 04 24 c7 44 00 00 	movl   $0x44c7,(%esp)
    1b69:	e8 8d 1d 00 00       	call   38fb <unlink>
  if(mkdir("dd") != 0){
    1b6e:	c7 04 24 64 45 00 00 	movl   $0x4564,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1b8d:	68 9d 44 00 00       	push   $0x449d
  ...
  write(fd, "ff", 2);
    ...
    1ba7:	6a 02                	push   $0x2
    1ba9:	68 c7 44 00 00       	push   $0x44c7
    1bae:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1bbc:	c7 04 24 64 45 00 00 	movl   $0x4564,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1bd6:	68 78 44 00 00       	push   $0x4478
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1bf3:	68 9a 44 00 00       	push   $0x449a
  ...
  write(fd, "FF", 2);
    ...
    1c0d:	6a 02                	push   $0x2
    1c0f:	68 bb 44 00 00       	push   $0x44bb
    1c14:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1c25:	6a 00                	push   $0x0
    1c27:	68 be 44 00 00       	push   $0x44be
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    1c76:	68 fe 44 00 00       	push   $0x44fe
    1c7b:	68 9a 44 00 00       	push   $0x449a
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1c93:	68 9a 44 00 00       	push   $0x449a
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1cab:	6a 00                	push   $0x0
    1cad:	68 9a 44 00 00       	push   $0x449a
  ...
  if(chdir("dd") != 0){
    ...
    1cc5:	68 64 45 00 00       	push   $0x4564
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1cdd:	68 32 45 00 00       	push   $0x4532
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1cf5:	68 58 45 00 00       	push   $0x4558
  ...
  if(chdir("./..") != 0){
    ...
    1d0d:	68 67 45 00 00       	push   $0x4567
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1d25:	6a 00                	push   $0x0
    1d27:	68 fe 44 00 00       	push   $0x44fe
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1d69:	6a 00                	push   $0x0
    1d6b:	68 9a 44 00 00       	push   $0x449a
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d88:	68 b2 45 00 00       	push   $0x45b2
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1da5:	68 d7 45 00 00       	push   $0x45d7
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1dc2:	68 64 45 00 00       	push   $0x4564
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1dda:	6a 02                	push   $0x2
    1ddc:	68 64 45 00 00       	push   $0x4564
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1df4:	6a 01                	push   $0x1
    1df6:	68 64 45 00 00       	push   $0x4564
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1e0e:	68 46 46 00 00       	push   $0x4646
    1e13:	68 b2 45 00 00       	push   $0x45b2
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1e2b:	68 46 46 00 00       	push   $0x4646
    1e30:	68 d7 45 00 00       	push   $0x45d7
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1e48:	68 fe 44 00 00       	push   $0x44fe
    1e4d:	68 9d 44 00 00       	push   $0x449d
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    1e65:	68 b2 45 00 00       	push   $0x45b2
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    1e7d:	68 d7 45 00 00       	push   $0x45d7
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    1e95:	68 fe 44 00 00       	push   $0x44fe
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    1ead:	68 d7 45 00 00       	push   $0x45d7
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    1ec5:	68 b2 45 00 00       	push   $0x45b2
  ...
  if(chdir("dd/ff") == 0){
    ...
    1edd:	68 9d 44 00 00       	push   $0x449d
  ...
  if(chdir("dd/xx") == 0){
    ...
    1ef5:	68 49 46 00 00       	push   $0x4649
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    1f0d:	68 fe 44 00 00       	push   $0x44fe
  ...
  if(unlink("dd/ff") != 0){
    ...
    1f25:	68 9d 44 00 00       	push   $0x449d
  ...
  if(unlink("dd") == 0){
    ...
    1f3d:	68 64 45 00 00       	push   $0x4564
  ...
  if(unlink("dd/dd") < 0){
    ...
    1f55:	68 79 44 00 00       	push   $0x4479
  ...
  if(unlink("dd") < 0){
    ...
    1f6d:	68 64 45 00 00       	push   $0x4564
  ...
  printf(1, "subdir ok\n");
    ...
    1f85:	68 46 47 00 00       	push   $0x4746
    1f8a:	6a 01                	push   $0x1
    1f8c:	e8 a3 1a 00 00       	call   3a34 <printf>
}
    ...
    1f9c:	68 4b 44 00 00       	push   $0x444b
    1fa1:	6a 01                	push   $0x1
    1fa3:	e8 8c 1a 00 00       	call   3a34 <printf>
    exit();
    1fa8:	e8 fe 18 00 00       	call   38ab <exit>
    printf(1, "create dd/ff failed\n");
    1fad:	83 ec 08             	sub    $0x8,%esp
    1fb0:	68 63 44 00 00       	push   $0x4463
    1fb5:	6a 01                	push   $0x1
    1fb7:	e8 78 1a 00 00       	call   3a34 <printf>
    exit();
    1fbc:	e8 ea 18 00 00       	call   38ab <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    1fc1:	83 ec 08             	sub    $0x8,%esp
    1fc4:	68 30 4f 00 00       	push   $0x4f30
    1fc9:	6a 01                	push   $0x1
    1fcb:	e8 64 1a 00 00       	call   3a34 <printf>
    exit();
    1fd0:	e8 d6 18 00 00       	call   38ab <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    1fd5:	83 ec 08             	sub    $0x8,%esp
    1fd8:	68 7f 44 00 00       	push   $0x447f
    1fdd:	6a 01                	push   $0x1
    1fdf:	e8 50 1a 00 00       	call   3a34 <printf>
    exit();
    1fe4:	e8 c2 18 00 00       	call   38ab <exit>
    printf(1, "create dd/dd/ff failed\n");
    1fe9:	83 ec 08             	sub    $0x8,%esp
    1fec:	68 a3 44 00 00       	push   $0x44a3
    1ff1:	6a 01                	push   $0x1
    1ff3:	e8 3c 1a 00 00       	call   3a34 <printf>
    exit();
    1ff8:	e8 ae 18 00 00       	call   38ab <exit>
    printf(1, "open dd/dd/../ff failed\n");
    1ffd:	83 ec 08             	sub    $0x8,%esp
    2000:	68 ca 44 00 00       	push   $0x44ca
    2005:	6a 01                	push   $0x1
    2007:	e8 28 1a 00 00       	call   3a34 <printf>
    exit();
    200c:	e8 9a 18 00 00       	call   38ab <exit>
    printf(1, "dd/dd/../ff wrong content\n");
    2011:	83 ec 08             	sub    $0x8,%esp
    2014:	68 e3 44 00 00       	push   $0x44e3
    2019:	6a 01                	push   $0x1
    201b:	e8 14 1a 00 00       	call   3a34 <printf>
    exit();
    2020:	e8 86 18 00 00       	call   38ab <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2025:	83 ec 08             	sub    $0x8,%esp
    2028:	68 58 4f 00 00       	push   $0x4f58
    202d:	6a 01                	push   $0x1
    202f:	e8 00 1a 00 00       	call   3a34 <printf>
    exit();
    2034:	e8 72 18 00 00       	call   38ab <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    2039:	83 ec 08             	sub    $0x8,%esp
    203c:	68 09 45 00 00       	push   $0x4509
    2041:	6a 01                	push   $0x1
    2043:	e8 ec 19 00 00       	call   3a34 <printf>
    exit();
    2048:	e8 5e 18 00 00       	call   38ab <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    204d:	83 ec 08             	sub    $0x8,%esp
    2050:	68 7c 4f 00 00       	push   $0x4f7c
    2055:	6a 01                	push   $0x1
    2057:	e8 d8 19 00 00       	call   3a34 <printf>
    exit();
    205c:	e8 4a 18 00 00       	call   38ab <exit>
    printf(1, "chdir dd failed\n");
    2061:	83 ec 08             	sub    $0x8,%esp
    2064:	68 21 45 00 00       	push   $0x4521
    2069:	6a 01                	push   $0x1
    206b:	e8 c4 19 00 00       	call   3a34 <printf>
    exit();
    2070:	e8 36 18 00 00       	call   38ab <exit>
    printf(1, "chdir dd/../../dd failed\n");
    2075:	83 ec 08             	sub    $0x8,%esp
    2078:	68 3e 45 00 00       	push   $0x453e
    207d:	6a 01                	push   $0x1
    207f:	e8 b0 19 00 00       	call   3a34 <printf>
    exit();
    2084:	e8 22 18 00 00       	call   38ab <exit>
    printf(1, "chdir dd/../../dd failed\n");
    2089:	83 ec 08             	sub    $0x8,%esp
    208c:	68 3e 45 00 00       	push   $0x453e
    2091:	6a 01                	push   $0x1
    2093:	e8 9c 19 00 00       	call   3a34 <printf>
    exit();
    2098:	e8 0e 18 00 00       	call   38ab <exit>
    printf(1, "chdir ./.. failed\n");
    209d:	83 ec 08             	sub    $0x8,%esp
    20a0:	68 6c 45 00 00       	push   $0x456c
    20a5:	6a 01                	push   $0x1
    20a7:	e8 88 19 00 00       	call   3a34 <printf>
    exit();
    20ac:	e8 fa 17 00 00       	call   38ab <exit>
    printf(1, "open dd/dd/ffff failed\n");
    20b1:	83 ec 08             	sub    $0x8,%esp
    20b4:	68 7f 45 00 00       	push   $0x457f
    20b9:	6a 01                	push   $0x1
    20bb:	e8 74 19 00 00       	call   3a34 <printf>
    exit();
    20c0:	e8 e6 17 00 00       	call   38ab <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    20c5:	83 ec 08             	sub    $0x8,%esp
    20c8:	68 97 45 00 00       	push   $0x4597
    20cd:	6a 01                	push   $0x1
    20cf:	e8 60 19 00 00       	call   3a34 <printf>
    exit();
    20d4:	e8 d2 17 00 00       	call   38ab <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    20d9:	83 ec 08             	sub    $0x8,%esp
    20dc:	68 a0 4f 00 00       	push   $0x4fa0
    20e1:	6a 01                	push   $0x1
    20e3:	e8 4c 19 00 00       	call   3a34 <printf>
    exit();
    20e8:	e8 be 17 00 00       	call   38ab <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    20ed:	83 ec 08             	sub    $0x8,%esp
    20f0:	68 bb 45 00 00       	push   $0x45bb
    20f5:	6a 01                	push   $0x1
    20f7:	e8 38 19 00 00       	call   3a34 <printf>
    exit();
    20fc:	e8 aa 17 00 00       	call   38ab <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    2101:	83 ec 08             	sub    $0x8,%esp
    2104:	68 e0 45 00 00       	push   $0x45e0
    2109:	6a 01                	push   $0x1
    210b:	e8 24 19 00 00       	call   3a34 <printf>
    exit();
    2110:	e8 96 17 00 00       	call   38ab <exit>
    printf(1, "create dd succeeded!\n");
    2115:	83 ec 08             	sub    $0x8,%esp
    2118:	68 fc 45 00 00       	push   $0x45fc
    211d:	6a 01                	push   $0x1
    211f:	e8 10 19 00 00       	call   3a34 <printf>
    exit();
    2124:	e8 82 17 00 00       	call   38ab <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2129:	83 ec 08             	sub    $0x8,%esp
    212c:	68 12 46 00 00       	push   $0x4612
    2131:	6a 01                	push   $0x1
    2133:	e8 fc 18 00 00       	call   3a34 <printf>
    exit();
    2138:	e8 6e 17 00 00       	call   38ab <exit>
    printf(1, "open dd wronly succeeded!\n");
    213d:	83 ec 08             	sub    $0x8,%esp
    2140:	68 2b 46 00 00       	push   $0x462b
    2145:	6a 01                	push   $0x1
    2147:	e8 e8 18 00 00       	call   3a34 <printf>
    exit();
    214c:	e8 5a 17 00 00       	call   38ab <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    2151:	83 ec 08             	sub    $0x8,%esp
    2154:	68 c8 4f 00 00       	push   $0x4fc8
    2159:	6a 01                	push   $0x1
    215b:	e8 d4 18 00 00       	call   3a34 <printf>
    exit();
    2160:	e8 46 17 00 00       	call   38ab <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2165:	83 ec 08             	sub    $0x8,%esp
    2168:	68 ec 4f 00 00       	push   $0x4fec
    216d:	6a 01                	push   $0x1
    216f:	e8 c0 18 00 00       	call   3a34 <printf>
    exit();
    2174:	e8 32 17 00 00       	call   38ab <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2179:	83 ec 08             	sub    $0x8,%esp
    217c:	68 10 50 00 00       	push   $0x5010
    2181:	6a 01                	push   $0x1
    2183:	e8 ac 18 00 00       	call   3a34 <printf>
    exit();
    2188:	e8 1e 17 00 00       	call   38ab <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    218d:	83 ec 08             	sub    $0x8,%esp
    2190:	68 4f 46 00 00       	push   $0x464f
    2195:	6a 01                	push   $0x1
    2197:	e8 98 18 00 00       	call   3a34 <printf>
    exit();
    219c:	e8 0a 17 00 00       	call   38ab <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    21a1:	83 ec 08             	sub    $0x8,%esp
    21a4:	68 6a 46 00 00       	push   $0x466a
    21a9:	6a 01                	push   $0x1
    21ab:	e8 84 18 00 00       	call   3a34 <printf>
    exit();
    21b0:	e8 f6 16 00 00       	call   38ab <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    21b5:	83 ec 08             	sub    $0x8,%esp
    21b8:	68 85 46 00 00       	push   $0x4685
    21bd:	6a 01                	push   $0x1
    21bf:	e8 70 18 00 00       	call   3a34 <printf>
    exit();
    21c4:	e8 e2 16 00 00       	call   38ab <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    21c9:	83 ec 08             	sub    $0x8,%esp
    21cc:	68 a2 46 00 00       	push   $0x46a2
    21d1:	6a 01                	push   $0x1
    21d3:	e8 5c 18 00 00       	call   3a34 <printf>
    exit();
    21d8:	e8 ce 16 00 00       	call   38ab <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    21dd:	83 ec 08             	sub    $0x8,%esp
    21e0:	68 be 46 00 00       	push   $0x46be
    21e5:	6a 01                	push   $0x1
    21e7:	e8 48 18 00 00       	call   3a34 <printf>
    exit();
    21ec:	e8 ba 16 00 00       	call   38ab <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    21f1:	83 ec 08             	sub    $0x8,%esp
    21f4:	68 da 46 00 00       	push   $0x46da
    21f9:	6a 01                	push   $0x1
    21fb:	e8 34 18 00 00       	call   3a34 <printf>
    exit();
    2200:	e8 a6 16 00 00       	call   38ab <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    2205:	83 ec 08             	sub    $0x8,%esp
    2208:	68 f2 46 00 00       	push   $0x46f2
    220d:	6a 01                	push   $0x1
    220f:	e8 20 18 00 00       	call   3a34 <printf>
    exit();
    2214:	e8 92 16 00 00       	call   38ab <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    2219:	83 ec 08             	sub    $0x8,%esp
    221c:	68 09 45 00 00       	push   $0x4509
    2221:	6a 01                	push   $0x1
    2223:	e8 0c 18 00 00       	call   3a34 <printf>
    exit();
    2228:	e8 7e 16 00 00       	call   38ab <exit>
    printf(1, "unlink dd/ff failed\n");
    222d:	83 ec 08             	sub    $0x8,%esp
    2230:	68 0a 47 00 00       	push   $0x470a
    2235:	6a 01                	push   $0x1
    2237:	e8 f8 17 00 00       	call   3a34 <printf>
    exit();
    223c:	e8 6a 16 00 00       	call   38ab <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2241:	83 ec 08             	sub    $0x8,%esp
    2244:	68 34 50 00 00       	push   $0x5034
    2249:	6a 01                	push   $0x1
    224b:	e8 e4 17 00 00       	call   3a34 <printf>
    exit();
    2250:	e8 56 16 00 00       	call   38ab <exit>
    printf(1, "unlink dd/dd failed\n");
    2255:	83 ec 08             	sub    $0x8,%esp
    2258:	68 1f 47 00 00       	push   $0x471f
    225d:	6a 01                	push   $0x1
    225f:	e8 d0 17 00 00       	call   3a34 <printf>
    exit();
    2264:	e8 42 16 00 00       	call   38ab <exit>
    printf(1, "unlink dd failed\n");
    2269:	83 ec 08             	sub    $0x8,%esp
    226c:	68 34 47 00 00       	push   $0x4734
    2271:	6a 01                	push   $0x1
    2273:	e8 bc 17 00 00       	call   3a34 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    228a:	68 51 47 00 00       	push   $0x4751
    228f:	6a 01                	push   $0x1
    2291:	e8 9e 17 00 00       	call   3a34 <printf>

  unlink("bigwrite");
    2296:	c7 04 24 60 47 00 00 	movl   $0x4760,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    22af:	68 69 47 00 00       	push   $0x4769
    22b4:	6a 01                	push   $0x1
    22b6:	e8 79 17 00 00       	call   3a34 <printf>
      exit();
    ...
    22c0:	50                   	push   %eax
    22c1:	56                   	push   %esi
    22c2:	68 81 47 00 00       	push   $0x4781
    22c7:	6a 01                	push   $0x1
    22c9:	e8 66 17 00 00       	call   3a34 <printf>
        exit();
    ...
    unlink("bigwrite");
    22dc:	c7 04 24 60 47 00 00 	movl   $0x4760,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2301:	68 60 47 00 00       	push   $0x4760
  ...
  printf(1, "bigwrite ok\n");
    ...
    233c:	68 93 47 00 00       	push   $0x4793
    2341:	6a 01                	push   $0x1
    2343:	e8 ec 16 00 00       	call   3a34 <printf>
}
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    2360:	68 a0 47 00 00       	push   $0x47a0
    2365:	6a 01                	push   $0x1
    2367:	e8 c8 16 00 00       	call   3a34 <printf>

  unlink("bigfile");
    236c:	c7 04 24 bc 47 00 00 	movl   $0x47bc,(%esp)
    2373:	e8 83 15 00 00       	call   38fb <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2378:	83 c4 08             	add    $0x8,%esp
    237b:	68 02 02 00 00       	push   $0x202
    2380:	68 bc 47 00 00       	push   $0x47bc
  ...
  for(i = 0; i < 20; i++){
    ...
    23d5:	68 ae 47 00 00       	push   $0x47ae
    23da:	6a 01                	push   $0x1
    23dc:	e8 53 16 00 00       	call   3a34 <printf>
    exit();
    23e1:	e8 c5 14 00 00       	call   38ab <exit>
      printf(1, "write bigfile failed\n");
    23e6:	83 ec 08             	sub    $0x8,%esp
    23e9:	68 c4 47 00 00       	push   $0x47c4
    23ee:	6a 01                	push   $0x1
    23f0:	e8 3f 16 00 00       	call   3a34 <printf>
      exit();
  ...
  for(i = 0; ; i++){
    ...
    2471:	68 da 47 00 00       	push   $0x47da
    2476:	6a 01                	push   $0x1
    2478:	e8 b7 15 00 00       	call   3a34 <printf>
    exit();
    247d:	e8 29 14 00 00       	call   38ab <exit>
      printf(1, "read bigfile failed\n");
    2482:	83 ec 08             	sub    $0x8,%esp
    2485:	68 ef 47 00 00       	push   $0x47ef
    248a:	6a 01                	push   $0x1
    248c:	e8 a3 15 00 00       	call   3a34 <printf>
      exit();
    2491:	e8 15 14 00 00       	call   38ab <exit>
      printf(1, "short read bigfile\n");
    2496:	83 ec 08             	sub    $0x8,%esp
    2499:	68 04 48 00 00       	push   $0x4804
    249e:	6a 01                	push   $0x1
    24a0:	e8 8f 15 00 00       	call   3a34 <printf>
      exit();
    24a5:	e8 01 14 00 00       	call   38ab <exit>
      printf(1, "read bigfile wrong data\n");
    24aa:	83 ec 08             	sub    $0x8,%esp
    24ad:	68 18 48 00 00       	push   $0x4818
    24b2:	6a 01                	push   $0x1
    24b4:	e8 7b 15 00 00       	call   3a34 <printf>
      exit();
  ...
  unlink("bigfile");
    ...
    24d5:	68 bc 47 00 00       	push   $0x47bc
    24da:	e8 1c 14 00 00       	call   38fb <unlink>

  printf(1, "bigfile test ok\n");
    24df:	83 c4 08             	add    $0x8,%esp
    24e2:	68 4b 48 00 00       	push   $0x484b
    24e7:	6a 01                	push   $0x1
    24e9:	e8 46 15 00 00       	call   3a34 <printf>
}
    ...
    24fc:	68 31 48 00 00       	push   $0x4831
    2501:	6a 01                	push   $0x1
    2503:	e8 2c 15 00 00       	call   3a34 <printf>
    exit();
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    2517:	68 5c 48 00 00       	push   $0x485c
    251c:	6a 01                	push   $0x1
    251e:	e8 11 15 00 00       	call   3a34 <printf>

  if(mkdir("12345678901234") != 0){
    2523:	c7 04 24 97 48 00 00 	movl   $0x4897,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    253d:	68 54 50 00 00       	push   $0x5054
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    255a:	68 a4 50 00 00       	push   $0x50a4
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    257b:	6a 00                	push   $0x0
    257d:	68 14 51 00 00       	push   $0x5114
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    259b:	c7 04 24 88 48 00 00 	movl   $0x4888,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    25b1:	68 b0 51 00 00       	push   $0x51b0
  ...
  printf(1, "fourteen ok\n");
    ...
    25c5:	68 a6 48 00 00       	push   $0x48a6
    25ca:	6a 01                	push   $0x1
    25cc:	e8 63 14 00 00       	call   3a34 <printf>
}
    ...
    25d9:	68 6b 48 00 00       	push   $0x486b
    25de:	6a 01                	push   $0x1
    25e0:	e8 4f 14 00 00       	call   3a34 <printf>
    exit();
    25e5:	e8 c1 12 00 00       	call   38ab <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    25ea:	83 ec 08             	sub    $0x8,%esp
    25ed:	68 74 50 00 00       	push   $0x5074
    25f2:	6a 01                	push   $0x1
    25f4:	e8 3b 14 00 00       	call   3a34 <printf>
    exit();
    25f9:	e8 ad 12 00 00       	call   38ab <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    25fe:	83 ec 08             	sub    $0x8,%esp
    2601:	68 d4 50 00 00       	push   $0x50d4
    2606:	6a 01                	push   $0x1
    2608:	e8 27 14 00 00       	call   3a34 <printf>
    exit();
    260d:	e8 99 12 00 00       	call   38ab <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    2612:	83 ec 08             	sub    $0x8,%esp
    2615:	68 44 51 00 00       	push   $0x5144
    261a:	6a 01                	push   $0x1
    261c:	e8 13 14 00 00       	call   3a34 <printf>
    exit();
    2621:	e8 85 12 00 00       	call   38ab <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2626:	83 ec 08             	sub    $0x8,%esp
    2629:	68 80 51 00 00       	push   $0x5180
    262e:	6a 01                	push   $0x1
    2630:	e8 ff 13 00 00       	call   3a34 <printf>
    exit();
    2635:	e8 71 12 00 00       	call   38ab <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    263a:	83 ec 08             	sub    $0x8,%esp
    263d:	68 d0 51 00 00       	push   $0x51d0
    2642:	6a 01                	push   $0x1
    2644:	e8 eb 13 00 00       	call   3a34 <printf>
    exit();
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    2658:	68 b3 48 00 00       	push   $0x48b3
    265d:	6a 01                	push   $0x1
    265f:	e8 d0 13 00 00       	call   3a34 <printf>
  if(mkdir("dots") != 0){
    2664:	c7 04 24 bf 48 00 00 	movl   $0x48bf,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    267e:	68 bf 48 00 00       	push   $0x48bf
  ...
  if(unlink(".") == 0){
    ...
    2696:	68 6a 45 00 00       	push   $0x456a
  ...
  if(unlink("..") == 0){
    ...
    26ae:	68 69 45 00 00       	push   $0x4569
  ...
  if(chdir("/") != 0){
    ...
    26c6:	68 3d 3d 00 00       	push   $0x3d3d
  ...
  if(unlink("dots/.") == 0){
    ...
    26de:	68 07 49 00 00       	push   $0x4907
  ...
  if(unlink("dots/..") == 0){
    ...
    26f6:	68 25 49 00 00       	push   $0x4925
  ...
  if(unlink("dots") != 0){
    ...
    270e:	68 bf 48 00 00       	push   $0x48bf
  ...
  printf(1, "rmdot ok\n");
    ...
    2726:	68 5a 49 00 00       	push   $0x495a
    272b:	6a 01                	push   $0x1
    272d:	e8 02 13 00 00       	call   3a34 <printf>
}
    ...
    273a:	68 c4 48 00 00       	push   $0x48c4
    273f:	6a 01                	push   $0x1
    2741:	e8 ee 12 00 00       	call   3a34 <printf>
    exit();
    2746:	e8 60 11 00 00       	call   38ab <exit>
    printf(1, "chdir dots failed\n");
    274b:	83 ec 08             	sub    $0x8,%esp
    274e:	68 d7 48 00 00       	push   $0x48d7
    2753:	6a 01                	push   $0x1
    2755:	e8 da 12 00 00       	call   3a34 <printf>
    exit();
    275a:	e8 4c 11 00 00       	call   38ab <exit>
    printf(1, "rm . worked!\n");
    275f:	83 ec 08             	sub    $0x8,%esp
    2762:	68 ea 48 00 00       	push   $0x48ea
    2767:	6a 01                	push   $0x1
    2769:	e8 c6 12 00 00       	call   3a34 <printf>
    exit();
    276e:	e8 38 11 00 00       	call   38ab <exit>
    printf(1, "rm .. worked!\n");
    2773:	83 ec 08             	sub    $0x8,%esp
    2776:	68 f8 48 00 00       	push   $0x48f8
    277b:	6a 01                	push   $0x1
    277d:	e8 b2 12 00 00       	call   3a34 <printf>
    exit();
    2782:	e8 24 11 00 00       	call   38ab <exit>
    printf(1, "chdir / failed\n");
    2787:	83 ec 08             	sub    $0x8,%esp
    278a:	68 3f 3d 00 00       	push   $0x3d3f
    278f:	6a 01                	push   $0x1
    2791:	e8 9e 12 00 00       	call   3a34 <printf>
    exit();
    2796:	e8 10 11 00 00       	call   38ab <exit>
    printf(1, "unlink dots/. worked!\n");
    279b:	83 ec 08             	sub    $0x8,%esp
    279e:	68 0e 49 00 00       	push   $0x490e
    27a3:	6a 01                	push   $0x1
    27a5:	e8 8a 12 00 00       	call   3a34 <printf>
    exit();
    27aa:	e8 fc 10 00 00       	call   38ab <exit>
    printf(1, "unlink dots/.. worked!\n");
    27af:	83 ec 08             	sub    $0x8,%esp
    27b2:	68 2d 49 00 00       	push   $0x492d
    27b7:	6a 01                	push   $0x1
    27b9:	e8 76 12 00 00       	call   3a34 <printf>
    exit();
    27be:	e8 e8 10 00 00       	call   38ab <exit>
    printf(1, "unlink dots failed!\n");
    27c3:	83 ec 08             	sub    $0x8,%esp
    27c6:	68 45 49 00 00       	push   $0x4945
    27cb:	6a 01                	push   $0x1
    27cd:	e8 62 12 00 00       	call   3a34 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    27e2:	68 64 49 00 00       	push   $0x4964
    27e7:	6a 01                	push   $0x1
    27e9:	e8 46 12 00 00       	call   3a34 <printf>

  fd = open("dirfile", O_CREATE);
    27ee:	83 c4 08             	add    $0x8,%esp
    27f1:	68 00 02 00 00       	push   $0x200
    27f6:	68 71 49 00 00       	push   $0x4971
  ...
  if(chdir("dirfile") == 0){
    2814:	c7 04 24 71 49 00 00 	movl   $0x4971,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    282e:	6a 00                	push   $0x0
    2830:	68 aa 49 00 00       	push   $0x49aa
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    284d:	68 aa 49 00 00       	push   $0x49aa
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2865:	68 aa 49 00 00       	push   $0x49aa
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    287d:	68 aa 49 00 00       	push   $0x49aa
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2895:	68 aa 49 00 00       	push   $0x49aa
    289a:	68 0e 4a 00 00       	push   $0x4a0e
  ...
  fd = open(".", O_RDWR);
    ...
    28ca:	6a 02                	push   $0x2
    28cc:	68 6a 45 00 00       	push   $0x456a
  ...
  printf(1, "dir vs file OK\n");
    ...
    2919:	68 41 4a 00 00       	push   $0x4a41
    291e:	6a 01                	push   $0x1
    2920:	e8 0f 11 00 00       	call   3a34 <printf>
}
    ...
    2930:	68 79 49 00 00       	push   $0x4979
    2935:	6a 01                	push   $0x1
    2937:	e8 f8 10 00 00       	call   3a34 <printf>
    exit();
    293c:	e8 6a 0f 00 00       	call   38ab <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2941:	83 ec 08             	sub    $0x8,%esp
    2944:	68 90 49 00 00       	push   $0x4990
    2949:	6a 01                	push   $0x1
    294b:	e8 e4 10 00 00       	call   3a34 <printf>
    exit();
    2950:	e8 56 0f 00 00       	call   38ab <exit>
    printf(1, "create dirfile/xx succeeded!\n");
    2955:	83 ec 08             	sub    $0x8,%esp
    2958:	68 b5 49 00 00       	push   $0x49b5
    295d:	6a 01                	push   $0x1
    295f:	e8 d0 10 00 00       	call   3a34 <printf>
    exit();
    2964:	e8 42 0f 00 00       	call   38ab <exit>
    printf(1, "create dirfile/xx succeeded!\n");
    2969:	83 ec 08             	sub    $0x8,%esp
    296c:	68 b5 49 00 00       	push   $0x49b5
    2971:	6a 01                	push   $0x1
    2973:	e8 bc 10 00 00       	call   3a34 <printf>
    exit();
    2978:	e8 2e 0f 00 00       	call   38ab <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    297d:	83 ec 08             	sub    $0x8,%esp
    2980:	68 d3 49 00 00       	push   $0x49d3
    2985:	6a 01                	push   $0x1
    2987:	e8 a8 10 00 00       	call   3a34 <printf>
    exit();
    298c:	e8 1a 0f 00 00       	call   38ab <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2991:	83 ec 08             	sub    $0x8,%esp
    2994:	68 f0 49 00 00       	push   $0x49f0
    2999:	6a 01                	push   $0x1
    299b:	e8 94 10 00 00       	call   3a34 <printf>
    exit();
    29a0:	e8 06 0f 00 00       	call   38ab <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    29a5:	83 ec 08             	sub    $0x8,%esp
    29a8:	68 04 52 00 00       	push   $0x5204
    29ad:	6a 01                	push   $0x1
    29af:	e8 80 10 00 00       	call   3a34 <printf>
    exit();
    29b4:	e8 f2 0e 00 00       	call   38ab <exit>
    printf(1, "unlink dirfile failed!\n");
    29b9:	83 ec 08             	sub    $0x8,%esp
    29bc:	68 15 4a 00 00       	push   $0x4a15
    29c1:	6a 01                	push   $0x1
    29c3:	e8 6c 10 00 00       	call   3a34 <printf>
    exit();
    29c8:	e8 de 0e 00 00       	call   38ab <exit>
    printf(1, "open . for writing succeeded!\n");
    29cd:	83 ec 08             	sub    $0x8,%esp
    29d0:	68 24 52 00 00       	push   $0x5224
    29d5:	6a 01                	push   $0x1
    29d7:	e8 58 10 00 00       	call   3a34 <printf>
    exit();
    29dc:	e8 ca 0e 00 00       	call   38ab <exit>
    printf(1, "write . succeeded!\n");
    29e1:	83 ec 08             	sub    $0x8,%esp
    29e4:	68 2d 4a 00 00       	push   $0x4a2d
    29e9:	6a 01                	push   $0x1
    29eb:	e8 44 10 00 00       	call   3a34 <printf>
    exit();
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2a00:	68 51 4a 00 00       	push   $0x4a51
    2a05:	6a 01                	push   $0x1
    2a07:	e8 28 10 00 00       	call   3a34 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2a19:	68 68 4a 00 00       	push   $0x4a68
    2a1e:	6a 01                	push   $0x1
    2a20:	e8 0f 10 00 00       	call   3a34 <printf>
      exit();
    ...
    2a2d:	68 7c 4a 00 00       	push   $0x4a7c
    2a32:	6a 01                	push   $0x1
    2a34:	e8 fb 0f 00 00       	call   3a34 <printf>
      exit();
    ...
    2a52:	68 4c 46 00 00       	push   $0x464c
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2a6e:	68 62 4a 00 00       	push   $0x4a62
    ...
    2a82:	68 62 4a 00 00       	push   $0x4a62
    ...
    2ad7:	68 4c 46 00 00       	push   $0x464c
  ...
  chdir("/");
    ...
    2b00:	68 3d 3d 00 00       	push   $0x3d3d
    2b05:	e8 11 0e 00 00       	call   391b <chdir>
  printf(1, "empty file name OK\n");
    2b0a:	83 c4 08             	add    $0x8,%esp
    2b0d:	68 90 4a 00 00       	push   $0x4a90
    2b12:	6a 01                	push   $0x1
    2b14:	e8 1b 0f 00 00       	call   3a34 <printf>
}
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2b2c:	68 a4 4a 00 00       	push   $0x4aa4
    2b31:	6a 01                	push   $0x1
    2b33:	e8 fc 0e 00 00       	call   3a34 <printf>
  ...
  for(; n > 0; n--){
    ...
    2b7a:	68 44 52 00 00       	push   $0x5244
    2b7f:	6a 01                	push   $0x1
    2b81:	e8 ae 0e 00 00       	call   3a34 <printf>
    exit();
    2b86:	e8 20 0d 00 00       	call   38ab <exit>
      printf(1, "wait stopped early\n");
    2b8b:	83 ec 08             	sub    $0x8,%esp
    2b8e:	68 af 4a 00 00       	push   $0x4aaf
    2b93:	6a 01                	push   $0x1
    2b95:	e8 9a 0e 00 00       	call   3a34 <printf>
      exit();
  ...
  printf(1, "fork test OK\n");
    ...
    2bac:	68 d6 4a 00 00       	push   $0x4ad6
    2bb1:	6a 01                	push   $0x1
    2bb3:	e8 7c 0e 00 00       	call   3a34 <printf>
}
    ...
    2bc3:	68 c3 4a 00 00       	push   $0x4ac3
    2bc8:	6a 01                	push   $0x1
    2bca:	e8 65 0e 00 00       	call   3a34 <printf>
    exit();
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2be1:	68 e4 4a 00 00       	push   $0x4ae4
    2be6:	ff 35 80 5d 00 00    	pushl  0x5d80
    2bec:	e8 43 0e 00 00       	call   3a34 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    2c3d:	56                   	push   %esi
    2c3e:	53                   	push   %ebx
    2c3f:	68 ef 4a 00 00       	push   $0x4aef
    2c44:	ff 35 80 5d 00 00    	pushl  0x5d80
    2c4a:	e8 e5 0d 00 00       	call   3a34 <printf>
      exit();
...
#define BIG (100*1024*1024)
  ...
  *lastaddr = 99;
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2dba:	68 0a 4b 00 00       	push   $0x4b0a
    2dbf:	ff 35 80 5d 00 00    	pushl  0x5d80
    2dc5:	e8 6a 0c 00 00       	call   3a34 <printf>
    exit();
    2dca:	e8 dc 0a 00 00       	call   38ab <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    2dcf:	83 ec 08             	sub    $0x8,%esp
    2dd2:	68 21 4b 00 00       	push   $0x4b21
    2dd7:	ff 35 80 5d 00 00    	pushl  0x5d80
    2ddd:	e8 52 0c 00 00       	call   3a34 <printf>
    exit();
    ...
    2def:	68 68 52 00 00       	push   $0x5268
    2df4:	ff 35 80 5d 00 00    	pushl  0x5d80
    2dfa:	e8 35 0c 00 00       	call   3a34 <printf>
    exit();
    2dff:	e8 a7 0a 00 00       	call   38ab <exit>
    printf(stdout, "sbrk could not deallocate\n");
    2e04:	83 ec 08             	sub    $0x8,%esp
    2e07:	68 3d 4b 00 00       	push   $0x4b3d
    2e0c:	ff 35 80 5d 00 00    	pushl  0x5d80
    2e12:	e8 1d 0c 00 00       	call   3a34 <printf>
    exit();
    2e17:	e8 8f 0a 00 00       	call   38ab <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    2e1c:	50                   	push   %eax
    2e1d:	53                   	push   %ebx
    2e1e:	68 a8 52 00 00       	push   $0x52a8
    2e23:	ff 35 80 5d 00 00    	pushl  0x5d80
    2e29:	e8 06 0c 00 00       	call   3a34 <printf>
    exit();
    2e2e:	e8 78 0a 00 00       	call   38ab <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    2e33:	56                   	push   %esi
    2e34:	53                   	push   %ebx
    2e35:	68 e0 52 00 00       	push   $0x52e0
    2e3a:	ff 35 80 5d 00 00    	pushl  0x5d80
    2e40:	e8 ef 0b 00 00       	call   3a34 <printf>
    exit();
    2e45:	e8 61 0a 00 00       	call   38ab <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    2e4a:	83 ec 08             	sub    $0x8,%esp
    2e4d:	68 08 53 00 00       	push   $0x5308
    2e52:	ff 35 80 5d 00 00    	pushl  0x5d80
    2e58:	e8 d7 0b 00 00       	call   3a34 <printf>
    exit();
    2e5d:	e8 49 0a 00 00       	call   38ab <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    2e62:	50                   	push   %eax
    2e63:	53                   	push   %ebx
    2e64:	68 38 53 00 00       	push   $0x5338
    2e69:	ff 35 80 5d 00 00    	pushl  0x5d80
    2e6f:	e8 c0 0b 00 00       	call   3a34 <printf>
    exit();
    2e74:	e8 32 0a 00 00       	call   38ab <exit>
      printf(stdout, "fork failed\n");
    2e79:	83 ec 08             	sub    $0x8,%esp
    2e7c:	68 35 4c 00 00       	push   $0x4c35
    2e81:	ff 35 80 5d 00 00    	pushl  0x5d80
    2e87:	e8 a8 0b 00 00       	call   3a34 <printf>
      exit();
    ...
    2e94:	50                   	push   %eax
    2e95:	53                   	push   %ebx
    2e96:	68 58 4b 00 00       	push   $0x4b58
    2e9b:	ff 35 80 5d 00 00    	pushl  0x5d80
    2ea1:	e8 8e 0b 00 00       	call   3a34 <printf>
      kill(ppid);
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2ecf:	68 2d 40 00 00       	push   $0x402d
    2ed4:	6a 01                	push   $0x1
    2ed6:	e8 59 0b 00 00       	call   3a34 <printf>
    exit();
    ...
    2efe:	6a 01                	push   $0x1
    2f00:	68 4d 46 00 00       	push   $0x464d
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fa3:	68 8c 4b 00 00       	push   $0x4b8c
    2fa8:	ff 35 80 5d 00 00    	pushl  0x5d80
    2fae:	e8 81 0a 00 00       	call   3a34 <printf>
}
    ...
    2fc1:	68 71 4b 00 00       	push   $0x4b71
    2fc6:	ff 35 80 5d 00 00    	pushl  0x5d80
    2fcc:	e8 63 0a 00 00       	call   3a34 <printf>
    exit();
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    3000:	68 9a 4b 00 00       	push   $0x4b9a
    3005:	ff 35 80 5d 00 00    	pushl  0x5d80
    300b:	e8 24 0a 00 00       	call   3a34 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    305e:	56                   	push   %esi
    305f:	68 a9 4b 00 00       	push   $0x4ba9
    ...
    3074:	68 b4 4b 00 00       	push   $0x4bb4
    3079:	ff 35 80 5d 00 00    	pushl  0x5d80
    307f:	e8 b0 09 00 00       	call   3a34 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    ...
    308c:	68 cd 4b 00 00       	push   $0x4bcd
    3091:	ff 35 80 5d 00 00    	pushl  0x5d80
    3097:	e8 98 09 00 00       	call   3a34 <printf>
}
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    30b0:	68 da 4b 00 00       	push   $0x4bda
    30b5:	ff 35 80 5d 00 00    	pushl  0x5d80
    30bb:	e8 74 09 00 00       	call   3a34 <printf>
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    30e0:	68 e4 4b 00 00       	push   $0x4be4
    30e5:	ff 35 80 5d 00 00    	pushl  0x5d80
    30eb:	e8 44 09 00 00       	call   3a34 <printf>
      exit();
  ...
  printf(stdout, "bss test ok\n");
    ...
    30f8:	68 f5 4b 00 00       	push   $0x4bf5
    30fd:	ff 35 80 5d 00 00    	pushl  0x5d80
    3103:	e8 2c 09 00 00       	call   3a34 <printf>
}
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    3117:	68 02 4c 00 00       	push   $0x4c02
  ...
  fd = open("bigarg-ok", 0);
    ...
    313b:	6a 00                	push   $0x0
    313d:	68 02 4c 00 00       	push   $0x4c02
  ...
  unlink("bigarg-ok");
    315b:	c7 04 24 02 4c 00 00 	movl   $0x4c02,(%esp)
    ...
    316c:	c7 04 85 a0 5d 00 00 	movl   $0x535c,0x5da0(,%eax,4)
    3173:	5c 53 00 00 
    ...
    318c:	68 0c 4c 00 00       	push   $0x4c0c
    3191:	ff 35 80 5d 00 00    	pushl  0x5d80
    3197:	e8 98 08 00 00       	call   3a34 <printf>
    exec("echo", args);
    319c:	83 c4 08             	add    $0x8,%esp
    319f:	68 a0 5d 00 00       	push   $0x5da0
    31a4:	68 d9 3d 00 00       	push   $0x3dd9
    31a9:	e8 35 07 00 00       	call   38e3 <exec>
    printf(stdout, "bigarg test ok\n");
    31ae:	83 c4 08             	add    $0x8,%esp
    31b1:	68 19 4c 00 00       	push   $0x4c19
    31b6:	ff 35 80 5d 00 00    	pushl  0x5d80
    31bc:	e8 73 08 00 00       	call   3a34 <printf>
    fd = open("bigarg-ok", O_CREATE);
    31c1:	83 c4 08             	add    $0x8,%esp
    31c4:	68 00 02 00 00       	push   $0x200
    31c9:	68 02 4c 00 00       	push   $0x4c02
    ...
    31e3:	68 29 4c 00 00       	push   $0x4c29
    31e8:	ff 35 80 5d 00 00    	pushl  0x5d80
    31ee:	e8 41 08 00 00       	call   3a34 <printf>
    exit();
    31f3:	e8 b3 06 00 00       	call   38ab <exit>
    printf(stdout, "bigarg test failed!\n");
    31f8:	83 ec 08             	sub    $0x8,%esp
    31fb:	68 42 4c 00 00       	push   $0x4c42
    3200:	ff 35 80 5d 00 00    	pushl  0x5d80
    3206:	e8 29 08 00 00       	call   3a34 <printf>
    exit();
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    321d:	68 57 4c 00 00       	push   $0x4c57
    3222:	6a 01                	push   $0x1
    3224:	e8 0b 08 00 00       	call   3a34 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    32ba:	56                   	push   %esi
    32bb:	68 64 4c 00 00       	push   $0x4c64
    32c0:	6a 01                	push   $0x1
    32c2:	e8 6d 07 00 00       	call   3a34 <printf>
    ...
    32e4:	50                   	push   %eax
    32e5:	68 70 4c 00 00       	push   $0x4c70
    32ea:	6a 01                	push   $0x1
    32ec:	e8 43 07 00 00       	call   3a34 <printf>
      break;
    ...
    3322:	57                   	push   %edi
    3323:	68 80 4c 00 00       	push   $0x4c80
    3328:	6a 01                	push   $0x1
    332a:	e8 05 07 00 00       	call   3a34 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    ...
    33ea:	68 90 4c 00 00       	push   $0x4c90
    33ef:	6a 01                	push   $0x1
    33f1:	e8 3e 06 00 00       	call   3a34 <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    340b:	68 a6 4c 00 00       	push   $0x4ca6
    3410:	6a 01                	push   $0x1
    3412:	e8 1d 06 00 00       	call   3a34 <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    342d:	68 b0 4c 00 00       	push   $0x4cb0
    3432:	6a 01                	push   $0x1
    3434:	e8 fb 05 00 00       	call   3a34 <printf>
}
    ...
    3452:	68 3c 54 00 00       	push   $0x543c
    3457:	6a 01                	push   $0x1
    3459:	e8 d6 05 00 00       	call   3a34 <printf>
    exit();
    345e:	e8 48 04 00 00       	call   38ab <exit>
    printf (1, "fork failed\n");
    3463:	83 ec 08             	sub    $0x8,%esp
    3466:	68 35 4c 00 00       	push   $0x4c35
    346b:	6a 01                	push   $0x1
    346d:	e8 c2 05 00 00       	call   3a34 <printf>
    exit();
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    3482:	6a 00                	push   $0x0
    3484:	68 bf 4c 00 00       	push   $0x4cbf
  ...
  printf(1, "arg test passed\n");
    ...
    34bb:	68 d1 4c 00 00       	push   $0x4cd1
    34c0:	6a 01                	push   $0x1
    34c2:	e8 6d 05 00 00       	call   3a34 <printf>
}
    ...
    34d2:	68 c4 4c 00 00       	push   $0x4cc4
    34d7:	6a 02                	push   $0x2
    34d9:	e8 56 05 00 00       	call   3a34 <printf>
    exit();
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    34e7:	69 05 7c 5d 00 00 0d 	imul   $0x19660d,0x5d7c,%eax
    34ee:	66 19 00 
    34f1:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    34f6:	a3 7c 5d 00 00       	mov    %eax,0x5d7c
  return randstate;
}
    34fb:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    3511:	68 e2 4c 00 00       	push   $0x4ce2
    3516:	6a 01                	push   $0x1
    3518:	e8 17 05 00 00       	call   3a34 <printf>

  if(open("usertests.ran", 0) >= 0){
    351d:	83 c4 08             	add    $0x8,%esp
    3520:	6a 00                	push   $0x0
    3522:	68 f6 4c 00 00       	push   $0x4cf6
    ...
    3536:	68 60 54 00 00       	push   $0x5460
    353b:	6a 01                	push   $0x1
    353d:	e8 f2 04 00 00       	call   3a34 <printf>
    exit();
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    354f:	68 f6 4c 00 00       	push   $0x4cf6
...
putc(int fd, char c)
{
    ...
    3996:	83 ec 1c             	sub    $0x1c,%esp
    3999:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
    399c:	6a 01                	push   $0x1
    399e:	8d 55 f4             	lea    -0xc(%ebp),%edx
    39a1:	52                   	push   %edx
    39a2:	50                   	push   %eax
    39a3:	e8 23 ff ff ff       	call   38cb <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    39b1:	56                   	push   %esi
    39b2:	53                   	push   %ebx
    39b3:	83 ec 2c             	sub    $0x2c,%esp
    39b6:	89 45 d0             	mov    %eax,-0x30(%ebp)
  ...
  neg = 0;
  if(sgn && xx < 0){
    39bb:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    39bf:	0f 95 c2             	setne  %dl
    39c2:	89 f0                	mov    %esi,%eax
    39c4:	c1 e8 1f             	shr    $0x1f,%eax
    39c7:	84 c2                	test   %al,%dl
    39c9:	74 42                	je     3a0d <printint+0x60>
    neg = 1;
    x = -xx;
    39cb:	f7 de                	neg    %esi
    neg = 1;
    39cd:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    39d4:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
    39d9:	89 f0                	mov    %esi,%eax
    39db:	ba 00 00 00 00       	mov    $0x0,%edx
    39e0:	f7 f1                	div    %ecx
    39e2:	89 df                	mov    %ebx,%edi
    39e4:	83 c3 01             	add    $0x1,%ebx
    39e7:	0f b6 92 94 54 00 00 	movzbl 0x5494(%edx),%edx
    39ee:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
    39f2:	89 f2                	mov    %esi,%edx
    39f4:	89 c6                	mov    %eax,%esi
    39f6:	39 d1                	cmp    %edx,%ecx
    39f8:	76 df                	jbe    39d9 <printint+0x2c>
  if(neg)
    39fa:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
    39fe:	74 2f                	je     3a2f <printint+0x82>
    buf[i++] = '-';
    3a00:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    3a05:	8d 5f 02             	lea    0x2(%edi),%ebx
    3a08:	8b 75 d0             	mov    -0x30(%ebp),%esi
    3a0b:	eb 15                	jmp    3a22 <printint+0x75>
  neg = 0;
    3a0d:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
    3a14:	eb be                	jmp    39d4 <printint+0x27>

  while(--i >= 0)
    putc(fd, buf[i]);
    3a16:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
    3a1b:	89 f0                	mov    %esi,%eax
    3a1d:	e8 71 ff ff ff       	call   3993 <putc>
  while(--i >= 0)
    3a22:	83 eb 01             	sub    $0x1,%ebx
    3a25:	79 ef                	jns    3a16 <printint+0x69>
}
    3a27:	83 c4 2c             	add    $0x2c,%esp
    3a2a:	5b                   	pop    %ebx
    3a2b:	5e                   	pop    %esi
    3a2c:	5f                   	pop    %edi
    3a2d:	5d                   	pop    %ebp
    3a2e:	c3                   	ret    
    3a2f:	8b 75 d0             	mov    -0x30(%ebp),%esi
    3a32:	eb ee                	jmp    3a22 <printint+0x75>
...
{
    3a34:	f3 0f 1e fb          	endbr32 
    3a38:	55                   	push   %ebp
    3a39:	89 e5                	mov    %esp,%ebp
    3a3b:	57                   	push   %edi
    3a3c:	56                   	push   %esi
    3a3d:	53                   	push   %ebx
    3a3e:	83 ec 1c             	sub    $0x1c,%esp
  char *s;
  int c, i, state;
  uint *ap;
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    3a41:	8d 45 10             	lea    0x10(%ebp),%eax
    3a44:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
    3a47:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
    3a4c:	bb 00 00 00 00       	mov    $0x0,%ebx
    3a51:	eb 14                	jmp    3a67 <printf+0x33>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
    3a53:	89 fa                	mov    %edi,%edx
    3a55:	8b 45 08             	mov    0x8(%ebp),%eax
    3a58:	e8 36 ff ff ff       	call   3993 <putc>
    3a5d:	eb 05                	jmp    3a64 <printf+0x30>
      }
    } else if(state == '%'){
    3a5f:	83 fe 25             	cmp    $0x25,%esi
    3a62:	74 25                	je     3a89 <printf+0x55>
  for(i = 0; fmt[i]; i++){
    3a64:	83 c3 01             	add    $0x1,%ebx
    3a67:	8b 45 0c             	mov    0xc(%ebp),%eax
    3a6a:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
    3a6e:	84 c0                	test   %al,%al
    3a70:	0f 84 23 01 00 00    	je     3b99 <printf+0x165>
    c = fmt[i] & 0xff;
    3a76:	0f be f8             	movsbl %al,%edi
    3a79:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
    3a7c:	85 f6                	test   %esi,%esi
    3a7e:	75 df                	jne    3a5f <printf+0x2b>
      if(c == '%'){
    3a80:	83 f8 25             	cmp    $0x25,%eax
    3a83:	75 ce                	jne    3a53 <printf+0x1f>
        state = '%';
    3a85:	89 c6                	mov    %eax,%esi
    3a87:	eb db                	jmp    3a64 <printf+0x30>
      if(c == 'd'){
    3a89:	83 f8 64             	cmp    $0x64,%eax
    3a8c:	74 49                	je     3ad7 <printf+0xa3>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    3a8e:	83 f8 78             	cmp    $0x78,%eax
    3a91:	0f 94 c1             	sete   %cl
    3a94:	83 f8 70             	cmp    $0x70,%eax
    3a97:	0f 94 c2             	sete   %dl
    3a9a:	08 d1                	or     %dl,%cl
    3a9c:	75 63                	jne    3b01 <printf+0xcd>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    3a9e:	83 f8 73             	cmp    $0x73,%eax
    3aa1:	0f 84 84 00 00 00    	je     3b2b <printf+0xf7>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    3aa7:	83 f8 63             	cmp    $0x63,%eax
    3aaa:	0f 84 b7 00 00 00    	je     3b67 <printf+0x133>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    3ab0:	83 f8 25             	cmp    $0x25,%eax
    3ab3:	0f 84 cc 00 00 00    	je     3b85 <printf+0x151>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    3ab9:	ba 25 00 00 00       	mov    $0x25,%edx
    3abe:	8b 45 08             	mov    0x8(%ebp),%eax
    3ac1:	e8 cd fe ff ff       	call   3993 <putc>
        putc(fd, c);
    3ac6:	89 fa                	mov    %edi,%edx
    3ac8:	8b 45 08             	mov    0x8(%ebp),%eax
    3acb:	e8 c3 fe ff ff       	call   3993 <putc>
      }
      state = 0;
    3ad0:	be 00 00 00 00       	mov    $0x0,%esi
    3ad5:	eb 8d                	jmp    3a64 <printf+0x30>
        printint(fd, *ap, 10, 1);
    3ad7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    3ada:	8b 17                	mov    (%edi),%edx
    3adc:	83 ec 0c             	sub    $0xc,%esp
    3adf:	6a 01                	push   $0x1
    3ae1:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3ae6:	8b 45 08             	mov    0x8(%ebp),%eax
    3ae9:	e8 bf fe ff ff       	call   39ad <printint>
        ap++;
    3aee:	83 c7 04             	add    $0x4,%edi
    3af1:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    3af4:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3af7:	be 00 00 00 00       	mov    $0x0,%esi
    3afc:	e9 63 ff ff ff       	jmp    3a64 <printf+0x30>
        printint(fd, *ap, 16, 0);
    3b01:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    3b04:	8b 17                	mov    (%edi),%edx
    3b06:	83 ec 0c             	sub    $0xc,%esp
    3b09:	6a 00                	push   $0x0
    3b0b:	b9 10 00 00 00       	mov    $0x10,%ecx
    3b10:	8b 45 08             	mov    0x8(%ebp),%eax
    3b13:	e8 95 fe ff ff       	call   39ad <printint>
        ap++;
    3b18:	83 c7 04             	add    $0x4,%edi
    3b1b:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    3b1e:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3b21:	be 00 00 00 00       	mov    $0x0,%esi
    3b26:	e9 39 ff ff ff       	jmp    3a64 <printf+0x30>
        s = (char*)*ap;
    3b2b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3b2e:	8b 30                	mov    (%eax),%esi
        ap++;
    3b30:	83 c0 04             	add    $0x4,%eax
    3b33:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
    3b36:	85 f6                	test   %esi,%esi
    3b38:	75 28                	jne    3b62 <printf+0x12e>
          s = "(null)";
    3b3a:	be 8a 54 00 00       	mov    $0x548a,%esi
    3b3f:	8b 7d 08             	mov    0x8(%ebp),%edi
    3b42:	eb 0d                	jmp    3b51 <printf+0x11d>
          putc(fd, *s);
    3b44:	0f be d2             	movsbl %dl,%edx
    3b47:	89 f8                	mov    %edi,%eax
    3b49:	e8 45 fe ff ff       	call   3993 <putc>
          s++;
    3b4e:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
    3b51:	0f b6 16             	movzbl (%esi),%edx
    3b54:	84 d2                	test   %dl,%dl
    3b56:	75 ec                	jne    3b44 <printf+0x110>
      state = 0;
    3b58:	be 00 00 00 00       	mov    $0x0,%esi
    3b5d:	e9 02 ff ff ff       	jmp    3a64 <printf+0x30>
    3b62:	8b 7d 08             	mov    0x8(%ebp),%edi
    3b65:	eb ea                	jmp    3b51 <printf+0x11d>
        putc(fd, *ap);
    3b67:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    3b6a:	0f be 17             	movsbl (%edi),%edx
    3b6d:	8b 45 08             	mov    0x8(%ebp),%eax
    3b70:	e8 1e fe ff ff       	call   3993 <putc>
        ap++;
    3b75:	83 c7 04             	add    $0x4,%edi
    3b78:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
    3b7b:	be 00 00 00 00       	mov    $0x0,%esi
    3b80:	e9 df fe ff ff       	jmp    3a64 <printf+0x30>
        putc(fd, c);
    3b85:	89 fa                	mov    %edi,%edx
    3b87:	8b 45 08             	mov    0x8(%ebp),%eax
    3b8a:	e8 04 fe ff ff       	call   3993 <putc>
      state = 0;
    3b8f:	be 00 00 00 00       	mov    $0x0,%esi
    3b94:	e9 cb fe ff ff       	jmp    3a64 <printf+0x30>
    }
  }
}
    3b99:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3b9c:	5b                   	pop    %ebx
    3b9d:	5e                   	pop    %esi
    3b9e:	5f                   	pop    %edi
    3b9f:	5d                   	pop    %ebp
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3bb1:	a1 20 5e 00 00       	mov    0x5e20,%eax
    3bb6:	eb 02                	jmp    3bba <free+0x19>
    3bb8:	89 d0                	mov    %edx,%eax
    3bba:	39 c8                	cmp    %ecx,%eax
    3bbc:	73 04                	jae    3bc2 <free+0x21>
    3bbe:	39 08                	cmp    %ecx,(%eax)
    3bc0:	77 12                	ja     3bd4 <free+0x33>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3bc2:	8b 10                	mov    (%eax),%edx
    3bc4:	39 c2                	cmp    %eax,%edx
    3bc6:	77 f0                	ja     3bb8 <free+0x17>
    3bc8:	39 c8                	cmp    %ecx,%eax
    3bca:	72 08                	jb     3bd4 <free+0x33>
    3bcc:	39 ca                	cmp    %ecx,%edx
    3bce:	77 04                	ja     3bd4 <free+0x33>
    3bd0:	89 d0                	mov    %edx,%eax
    3bd2:	eb e6                	jmp    3bba <free+0x19>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3bd4:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3bd7:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3bda:	8b 10                	mov    (%eax),%edx
    3bdc:	39 d7                	cmp    %edx,%edi
    3bde:	74 19                	je     3bf9 <free+0x58>
  ...
  if(p + p->s.size == bp){
    ...
    3be9:	39 ce                	cmp    %ecx,%esi
    3beb:	74 1b                	je     3c08 <free+0x67>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
  ...
  freep = p;
    3bef:	a3 20 5e 00 00       	mov    %eax,0x5e20
}
    3bf4:	5b                   	pop    %ebx
    3bf5:	5e                   	pop    %esi
    3bf6:	5f                   	pop    %edi
    ...
    3bf8:	c3                   	ret    
    bp->s.size += p->s.ptr->s.size;
    3bf9:	03 72 04             	add    0x4(%edx),%esi
    3bfc:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3bff:	8b 10                	mov    (%eax),%edx
    3c01:	8b 12                	mov    (%edx),%edx
    3c03:	89 53 f8             	mov    %edx,-0x8(%ebx)
    3c06:	eb db                	jmp    3be3 <free+0x42>
    p->s.size += bp->s.size;
    3c08:	03 53 fc             	add    -0x4(%ebx),%edx
    3c0b:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    3c0e:	8b 53 f8             	mov    -0x8(%ebx),%edx
    3c11:	89 10                	mov    %edx,(%eax)
    3c13:	eb da                	jmp    3bef <free+0x4e>
...
morecore(uint nu)
{
    ...
    3c18:	53                   	push   %ebx
    3c19:	83 ec 04             	sub    $0x4,%esp
    3c1c:	89 c3                	mov    %eax,%ebx
  char *p;
  Header *hp;

  if(nu < 4096)
    3c1e:	3d ff 0f 00 00       	cmp    $0xfff,%eax
    3c23:	77 05                	ja     3c2a <morecore+0x15>
    nu = 4096;
    3c25:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
    3c2a:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    3c31:	83 ec 0c             	sub    $0xc,%esp
    3c34:	50                   	push   %eax
    3c35:	e8 f9 fc ff ff       	call   3933 <sbrk>
  if(p == (char*)-1)
    3c3a:	83 c4 10             	add    $0x10,%esp
    3c3d:	83 f8 ff             	cmp    $0xffffffff,%eax
    3c40:	74 1c                	je     3c5e <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    3c42:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3c45:	83 c0 08             	add    $0x8,%eax
    3c48:	83 ec 0c             	sub    $0xc,%esp
    3c4b:	50                   	push   %eax
    3c4c:	e8 50 ff ff ff       	call   3ba1 <free>
  return freep;
    3c51:	a1 20 5e 00 00       	mov    0x5e20,%eax
    3c56:	83 c4 10             	add    $0x10,%esp
}
    3c59:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3c5c:	c9                   	leave  
    3c5d:	c3                   	ret    
    return 0;
    3c5e:	b8 00 00 00 00       	mov    $0x0,%eax
    3c63:	eb f4                	jmp    3c59 <morecore+0x44>
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    3c73:	8d 58 07             	lea    0x7(%eax),%ebx
    3c76:	c1 eb 03             	shr    $0x3,%ebx
    3c79:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
    3c7c:	8b 0d 20 5e 00 00    	mov    0x5e20,%ecx
    3c82:	85 c9                	test   %ecx,%ecx
    3c84:	74 04                	je     3c8a <malloc+0x25>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3c86:	8b 01                	mov    (%ecx),%eax
    3c88:	eb 4b                	jmp    3cd5 <malloc+0x70>
    base.s.ptr = freep = prevp = &base;
    3c8a:	c7 05 20 5e 00 00 24 	movl   $0x5e24,0x5e20
    3c91:	5e 00 00 
    3c94:	c7 05 24 5e 00 00 24 	movl   $0x5e24,0x5e24
    3c9b:	5e 00 00 
    base.s.size = 0;
    3c9e:	c7 05 28 5e 00 00 00 	movl   $0x0,0x5e28
    3ca5:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    3ca8:	b9 24 5e 00 00       	mov    $0x5e24,%ecx
    3cad:	eb d7                	jmp    3c86 <malloc+0x21>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    3caf:	74 1a                	je     3ccb <malloc+0x66>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    3cb1:	29 da                	sub    %ebx,%edx
    3cb3:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    3cb6:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
    3cb9:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
    3cbc:	89 0d 20 5e 00 00    	mov    %ecx,0x5e20
      return (void*)(p + 1);
    ...
    3cc5:	83 c4 04             	add    $0x4,%esp
    3cc8:	5b                   	pop    %ebx
    3cc9:	5d                   	pop    %ebp
    3cca:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    3ccb:	8b 10                	mov    (%eax),%edx
    3ccd:	89 11                	mov    %edx,(%ecx)
    3ccf:	eb eb                	jmp    3cbc <malloc+0x57>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3cd1:	89 c1                	mov    %eax,%ecx
    3cd3:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
    3cd5:	8b 50 04             	mov    0x4(%eax),%edx
    3cd8:	39 da                	cmp    %ebx,%edx
    3cda:	73 d3                	jae    3caf <malloc+0x4a>
    if(p == freep)
    3cdc:	39 05 20 5e 00 00    	cmp    %eax,0x5e20
    3ce2:	75 ed                	jne    3cd1 <malloc+0x6c>
      if((p = morecore(nunits)) == 0)
    3ce4:	89 d8                	mov    %ebx,%eax
    3ce6:	e8 2a ff ff ff       	call   3c15 <morecore>
    3ceb:	85 c0                	test   %eax,%eax
    3ced:	75 e2                	jne    3cd1 <malloc+0x6c>
    3cef:	eb d4                	jmp    3cc5 <malloc+0x60>
