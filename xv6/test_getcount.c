/* ...................................
   ...
   int getcount(int sysno) system call.
   It returns number of times a system call
   has invoked in process. Argument to getcount 
   is system call number defined in syscall.h.
*/
