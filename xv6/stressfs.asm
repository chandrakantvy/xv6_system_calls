...
main(int argc, char *argv[])
{
  ...
  2e:	68 fc 07 00 00       	push   $0x7fc
  33:	6a 01                	push   $0x1
  35:	e8 05 05 00 00       	call   53f <printf>
...
//    printf(fd, "%d\n", i);
  ...
  c7:	68 19 08 00 00       	push   $0x819
  cc:	6a 01                	push   $0x1
  ce:	e8 6c 04 00 00       	call   53f <printf>
...
putc(int fd, char c)
{
 ...
 4ac:	52                   	push   %edx
 4ad:	50                   	push   %eax
 4ae:	e8 23 ff ff ff       	call   3d6 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4c4:	89 d6                	mov    %edx,%esi
  ...
  neg = 0;
  if(sgn && xx < 0){
 4c6:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 4ca:	0f 95 c2             	setne  %dl
 4cd:	89 f0                	mov    %esi,%eax
 4cf:	c1 e8 1f             	shr    $0x1f,%eax
 4d2:	84 c2                	test   %al,%dl
 4d4:	74 42                	je     518 <printint+0x60>
    neg = 1;
    x = -xx;
 4d6:	f7 de                	neg    %esi
    neg = 1;
 4d8:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
 4df:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
 4e4:	89 f0                	mov    %esi,%eax
 4e6:	ba 00 00 00 00       	mov    $0x0,%edx
 4eb:	f7 f1                	div    %ecx
 4ed:	89 df                	mov    %ebx,%edi
 4ef:	83 c3 01             	add    $0x1,%ebx
 4f2:	0f b6 92 28 08 00 00 	movzbl 0x828(%edx),%edx
 4f9:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
 4fd:	89 f2                	mov    %esi,%edx
 4ff:	89 c6                	mov    %eax,%esi
 501:	39 d1                	cmp    %edx,%ecx
 503:	76 df                	jbe    4e4 <printint+0x2c>
  if(neg)
 505:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 509:	74 2f                	je     53a <printint+0x82>
    buf[i++] = '-';
 50b:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
 510:	8d 5f 02             	lea    0x2(%edi),%ebx
 513:	8b 75 d0             	mov    -0x30(%ebp),%esi
 516:	eb 15                	jmp    52d <printint+0x75>
  neg = 0;
 518:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 51f:	eb be                	jmp    4df <printint+0x27>

  while(--i >= 0)
    putc(fd, buf[i]);
 521:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 526:	89 f0                	mov    %esi,%eax
 528:	e8 71 ff ff ff       	call   49e <putc>
  while(--i >= 0)
 52d:	83 eb 01             	sub    $0x1,%ebx
 530:	79 ef                	jns    521 <printint+0x69>
}
 ...
 53d:	eb ee                	jmp    52d <printint+0x75>
...
printf(int fd, char *fmt, ...)
{
 ...
 568:	eb 05                	jmp    56f <printf+0x30>
      }
    } else if(state == '%'){
 56a:	83 fe 25             	cmp    $0x25,%esi
 56d:	74 25                	je     594 <printf+0x55>
  for(i = 0; fmt[i]; i++){
 56f:	83 c3 01             	add    $0x1,%ebx
 572:	8b 45 0c             	mov    0xc(%ebp),%eax
 575:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
 579:	84 c0                	test   %al,%al
 57b:	0f 84 23 01 00 00    	je     6a4 <printf+0x165>
    c = fmt[i] & 0xff;
 581:	0f be f8             	movsbl %al,%edi
 584:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
 587:	85 f6                	test   %esi,%esi
 589:	75 df                	jne    56a <printf+0x2b>
      if(c == '%'){
 58b:	83 f8 25             	cmp    $0x25,%eax
 58e:	75 ce                	jne    55e <printf+0x1f>
        state = '%';
 590:	89 c6                	mov    %eax,%esi
 592:	eb db                	jmp    56f <printf+0x30>
      if(c == 'd'){
 594:	83 f8 64             	cmp    $0x64,%eax
 597:	74 49                	je     5e2 <printf+0xa3>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 599:	83 f8 78             	cmp    $0x78,%eax
 59c:	0f 94 c1             	sete   %cl
 59f:	83 f8 70             	cmp    $0x70,%eax
 5a2:	0f 94 c2             	sete   %dl
 5a5:	08 d1                	or     %dl,%cl
 5a7:	75 63                	jne    60c <printf+0xcd>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 5a9:	83 f8 73             	cmp    $0x73,%eax
 5ac:	0f 84 84 00 00 00    	je     636 <printf+0xf7>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 5b2:	83 f8 63             	cmp    $0x63,%eax
 5b5:	0f 84 b7 00 00 00    	je     672 <printf+0x133>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 5bb:	83 f8 25             	cmp    $0x25,%eax
 5be:	0f 84 cc 00 00 00    	je     690 <printf+0x151>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 5c4:	ba 25 00 00 00       	mov    $0x25,%edx
 5c9:	8b 45 08             	mov    0x8(%ebp),%eax
 5cc:	e8 cd fe ff ff       	call   49e <putc>
        putc(fd, c);
 5d1:	89 fa                	mov    %edi,%edx
 5d3:	8b 45 08             	mov    0x8(%ebp),%eax
 5d6:	e8 c3 fe ff ff       	call   49e <putc>
      }
      state = 0;
 5db:	be 00 00 00 00       	mov    $0x0,%esi
 5e0:	eb 8d                	jmp    56f <printf+0x30>
        printint(fd, *ap, 10, 1);
 5e2:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 5e5:	8b 17                	mov    (%edi),%edx
 5e7:	83 ec 0c             	sub    $0xc,%esp
 5ea:	6a 01                	push   $0x1
 5ec:	b9 0a 00 00 00       	mov    $0xa,%ecx
 5f1:	8b 45 08             	mov    0x8(%ebp),%eax
 5f4:	e8 bf fe ff ff       	call   4b8 <printint>
        ap++;
 5f9:	83 c7 04             	add    $0x4,%edi
 5fc:	89 7d e4             	mov    %edi,-0x1c(%ebp)
 5ff:	83 c4 10             	add    $0x10,%esp
      state = 0;
 602:	be 00 00 00 00       	mov    $0x0,%esi
 607:	e9 63 ff ff ff       	jmp    56f <printf+0x30>
        printint(fd, *ap, 16, 0);
 ...
 61e:	e8 95 fe ff ff       	call   4b8 <printint>
        ap++;
 ...
 631:	e9 39 ff ff ff       	jmp    56f <printf+0x30>
        s = (char*)*ap;
 636:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 639:	8b 30                	mov    (%eax),%esi
        ap++;
 63b:	83 c0 04             	add    $0x4,%eax
 63e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
 641:	85 f6                	test   %esi,%esi
 643:	75 28                	jne    66d <printf+0x12e>
          s = "(null)";
 645:	be 1f 08 00 00       	mov    $0x81f,%esi
 64a:	8b 7d 08             	mov    0x8(%ebp),%edi
 64d:	eb 0d                	jmp    65c <printf+0x11d>
          putc(fd, *s);
 64f:	0f be d2             	movsbl %dl,%edx
 652:	89 f8                	mov    %edi,%eax
 654:	e8 45 fe ff ff       	call   49e <putc>
          s++;
 659:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 65c:	0f b6 16             	movzbl (%esi),%edx
 65f:	84 d2                	test   %dl,%dl
 661:	75 ec                	jne    64f <printf+0x110>
      state = 0;
 663:	be 00 00 00 00       	mov    $0x0,%esi
 668:	e9 02 ff ff ff       	jmp    56f <printf+0x30>
 66d:	8b 7d 08             	mov    0x8(%ebp),%edi
 670:	eb ea                	jmp    65c <printf+0x11d>
        putc(fd, *ap);
 672:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 675:	0f be 17             	movsbl (%edi),%edx
 678:	8b 45 08             	mov    0x8(%ebp),%eax
 67b:	e8 1e fe ff ff       	call   49e <putc>
        ap++;
 680:	83 c7 04             	add    $0x4,%edi
 683:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 686:	be 00 00 00 00       	mov    $0x0,%esi
 68b:	e9 df fe ff ff       	jmp    56f <printf+0x30>
        putc(fd, c);
 ...
 69f:	e9 cb fe ff ff       	jmp    56f <printf+0x30>
    }
  }
}
...
free(void *ap)
{
 ...
 6b6:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  bp = (Header*)ap - 1;
 6b9:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 6bc:	a1 2c 0b 00 00       	mov    0xb2c,%eax
 6c1:	eb 02                	jmp    6c5 <free+0x19>
 6c3:	89 d0                	mov    %edx,%eax
 6c5:	39 c8                	cmp    %ecx,%eax
 6c7:	73 04                	jae    6cd <free+0x21>
 6c9:	39 08                	cmp    %ecx,(%eax)
 6cb:	77 12                	ja     6df <free+0x33>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 6cd:	8b 10                	mov    (%eax),%edx
 6cf:	39 c2                	cmp    %eax,%edx
 6d1:	77 f0                	ja     6c3 <free+0x17>
 6d3:	39 c8                	cmp    %ecx,%eax
 6d5:	72 08                	jb     6df <free+0x33>
 6d7:	39 ca                	cmp    %ecx,%edx
 6d9:	77 04                	ja     6df <free+0x33>
 6db:	89 d0                	mov    %edx,%eax
 6dd:	eb e6                	jmp    6c5 <free+0x19>
      break;
  if(bp + bp->s.size == p->s.ptr){
 6df:	8b 73 fc             	mov    -0x4(%ebx),%esi
 6e2:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
 6e5:	8b 10                	mov    (%eax),%edx
 6e7:	39 d7                	cmp    %edx,%edi
 6e9:	74 19                	je     704 <free+0x58>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
 6eb:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
 6ee:	8b 50 04             	mov    0x4(%eax),%edx
 6f1:	8d 34 d0             	lea    (%eax,%edx,8),%esi
 6f4:	39 ce                	cmp    %ecx,%esi
 6f6:	74 1b                	je     713 <free+0x67>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
 6f8:	89 08                	mov    %ecx,(%eax)
  freep = p;
 ...
 707:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
 70a:	8b 10                	mov    (%eax),%edx
 70c:	8b 12                	mov    (%edx),%edx
 70e:	89 53 f8             	mov    %edx,-0x8(%ebx)
 711:	eb db                	jmp    6ee <free+0x42>
    p->s.size += bp->s.size;
 713:	03 53 fc             	add    -0x4(%ebx),%edx
 716:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 719:	8b 53 f8             	mov    -0x8(%ebx),%edx
 71c:	89 10                	mov    %edx,(%eax)
 71e:	eb da                	jmp    6fa <free+0x4e>
...
morecore(uint nu)
{
 ...
 727:	89 c3                	mov    %eax,%ebx
  ...
  if(nu < 4096)
 729:	3d ff 0f 00 00       	cmp    $0xfff,%eax
 72e:	77 05                	ja     735 <morecore+0x15>
    nu = 4096;
 730:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
 735:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 73c:	83 ec 0c             	sub    $0xc,%esp
 73f:	50                   	push   %eax
 740:	e8 f9 fc ff ff       	call   43e <sbrk>
  if(p == (char*)-1)
 745:	83 c4 10             	add    $0x10,%esp
 748:	83 f8 ff             	cmp    $0xffffffff,%eax
 74b:	74 1c                	je     769 <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 756:	50                   	push   %eax
 757:	e8 50 ff ff ff       	call   6ac <free>
  return freep;
 75c:	a1 2c 0b 00 00       	mov    0xb2c,%eax
 ...
 76e:	eb f4                	jmp    764 <morecore+0x44>
...
malloc(uint nbytes)
{
 ...
 784:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 787:	8b 0d 2c 0b 00 00    	mov    0xb2c,%ecx
 78d:	85 c9                	test   %ecx,%ecx
 78f:	74 04                	je     795 <malloc+0x25>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 791:	8b 01                	mov    (%ecx),%eax
 793:	eb 4b                	jmp    7e0 <malloc+0x70>
    base.s.ptr = freep = prevp = &base;
 795:	c7 05 2c 0b 00 00 30 	movl   $0xb30,0xb2c
 79c:	0b 00 00 
 79f:	c7 05 30 0b 00 00 30 	movl   $0xb30,0xb30
 7a6:	0b 00 00 
    base.s.size = 0;
 7a9:	c7 05 34 0b 00 00 00 	movl   $0x0,0xb34
 7b0:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 7b3:	b9 30 0b 00 00       	mov    $0xb30,%ecx
 7b8:	eb d7                	jmp    791 <malloc+0x21>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
 7ba:	74 1a                	je     7d6 <malloc+0x66>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
 ...
 7c4:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 7c7:	89 0d 2c 0b 00 00    	mov    %ecx,0xb2c
      return (void*)(p + 1);
 ...
 7d0:	83 c4 04             	add    $0x4,%esp
 7d3:	5b                   	pop    %ebx
 7d4:	5d                   	pop    %ebp
 7d5:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
 7d6:	8b 10                	mov    (%eax),%edx
 7d8:	89 11                	mov    %edx,(%ecx)
 7da:	eb eb                	jmp    7c7 <malloc+0x57>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7dc:	89 c1                	mov    %eax,%ecx
 7de:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
 7e0:	8b 50 04             	mov    0x4(%eax),%edx
 7e3:	39 da                	cmp    %ebx,%edx
 7e5:	73 d3                	jae    7ba <malloc+0x4a>
    if(p == freep)
 7e7:	39 05 2c 0b 00 00    	cmp    %eax,0xb2c
 7ed:	75 ed                	jne    7dc <malloc+0x6c>
      if((p = morecore(nunits)) == 0)
 7ef:	89 d8                	mov    %ebx,%eax
 7f1:	e8 2a ff ff ff       	call   720 <morecore>
 7f6:	85 c0                	test   %eax,%eax
 7f8:	75 e2                	jne    7dc <malloc+0x6c>
 7fa:	eb d4                	jmp    7d0 <malloc+0x60>
